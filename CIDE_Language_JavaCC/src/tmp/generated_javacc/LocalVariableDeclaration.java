...
public class LocalVariableDeclaration extends GenASTNode {
  public LocalVariableDeclaration(ASTTextNode text558, Type type, VariableDeclarator variableDeclarator, ArrayList<VariableDeclarator> variableDeclarator1, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyZeroOrOne<ASTTextNode>("text558", text558),
  ...
  public ASTTextNode getText558() {
    return ((PropertyZeroOrOne<ASTTextNode>)getProperty("text558")).getValue();
  }
  public Type getType() {
