...
public class local_lookahead extends GenASTNode {
  public local_lookahead(ASTStringNode integer_literal, ASTTextNode text469, expansion_choices expansion_choices, ASTTextNode text470, Expression expression, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyZeroOrOne<ASTStringNode>("integer_literal", integer_literal),
      new PropertyZeroOrOne<ASTTextNode>("text469", text469),
  ...
  public ASTTextNode getText469() {
    return ((PropertyZeroOrOne<ASTTextNode>)getProperty("text469")).getValue();
  }
