...
import tmp.generated_cppapprox.Function;
import tmp.generated_cppapprox.PPDefineStatement1;
import tmp.generated_cppapprox.PPIfDef_TopLevel;
import tmp.generated_cppapprox.PPIncludeStatement;
import tmp.generated_cppapprox.Statement;
...
@Ignore
public class CParserTest extends CPPApproxParserTester {
...
//	}
	...
	public void testFullNTFSLib() throws Exception {
		...
		parseFilesInFolder(folder, false,true);
	}
	...
	public void testFullBerkeleyDB4420() throws Exception {
		...
		assert folder.isDirectory();
		parseFilesInFolder(folder, true,false);
	}
