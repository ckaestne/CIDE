...
public class print_stmtEndP extends GenASTNode {
  public print_stmtEndP(ArrayList<test> test, ASTTextNode text4, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOneOrMore<test>("test", test),
      new PropertyZeroOrOne<ASTTextNode>("text4", text4)
  ...
  public ASTTextNode getText4() {
    return ((PropertyZeroOrOne<ASTTextNode>)getProperty("text4")).getValue();
  }
}
