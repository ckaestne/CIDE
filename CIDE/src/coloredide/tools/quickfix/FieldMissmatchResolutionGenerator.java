...
public class FieldMissmatchResolutionGenerator {
	...
	private static ASTNode getFieldDecl(IBinding binding) {
	...
	protected static Statement findCallingStatement(ASTNode node) {
