...
import cide.gparser.*;
  ...
  public class CApproxParser implements CApproxParserConstants {
  ...
  final public CodeUnit_TopLevel CodeUnit_TopLevel() throws ParseException {
    ...
    if (jj_2_2(2)) {
      ...
      pPOtherIgnore = PPOtherIgnore();
      t = findLineEnd();
                                                                       findlineend=new ASTStringNode(t.toString(),new WToken(t));
  ...
  final public CodeUnit_InBlock CodeUnit_InBlock() throws ParseException {
    ...
    if (jj_2_8(2)) {
      ...
      default:
        ...
        if (jj_2_12(2)) {
          gotoLabel = GotoLabel();
         {if (true) return new CodeUnit_InBlock10(gotoLabel, firstToken.next,token);}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case OCB:
            block = Block();
  ...
  final public IfStatement IfStatement() throws ParseException {
    ...
    jj_consume_token(OB);
    t = findEndCB();
                               findendcb=new ASTStringNode(t.toString(),new WToken(t));
    blockOrSingleStatement = BlockOrSingleStatement();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ELSE:
      elseBlock = ElseBlock();
    ...
    case OTHER:
      ...
      case OTHER:
        t = jj_consume_token(OTHER);
                   other=new ASTStringNode(t.toString(),new WToken(t));
        break;
      default:
        jj_la1[10] = jj_gen;
        ;
      ...
      t = jj_consume_token(LITERAL);
                                                                                      literal=new ASTStringNode(t.toString(),new WToken(t));
  ...
  final public PPDefineStatement PPDefineStatement() throws ParseException {
    ...
    if (jj_2_13(2)) {
      ...
      t = findLineEnd();
                                                 findlineend1=new ASTStringNode(t.toString(),new WToken(t));
  ...
  final public FunctionHeader FunctionHeader() throws ParseException {
    ...
    case STAR:
      jj_consume_token(STAR);
                                                                                                          text25=new ASTTextNode("*",new WToken(token));
      break;
    default:
      jj_la1[17] = jj_gen;
      ;
    ...
    t = jj_consume_token(IDENTIFIER);
                                                                                                                                                                                                                                   identifier=new ASTStringNode(t.toString(),new WToken(t));
    jj_consume_token(OB);
         {if (true) return new FunctionHeader(modifierList, functionReturnType, text25, functionExoticStuff, identifier, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FunctionReturnType FunctionReturnType() throws ParseException {
    ...
    case CONST:
      jj_consume_token(CONST);
                  text26=new ASTTextNode("const",new WToken(token));
      break;
    default:
      jj_la1[19] = jj_gen;
      ;
    ...
    case STRUCT:
      jj_consume_token(STRUCT);
                                                                                  text27=new ASTTextNode("struct",new WToken(token));
      break;
    default:
      jj_la1[20] = jj_gen;
      ;
    ...
    case UNSIGNED:
      jj_consume_token(UNSIGNED);
                                                                                                                                                     text28=new ASTTextNode("unsigned",new WToken(token));
      break;
    default:
      jj_la1[21] = jj_gen;
      ;
    ...
    t = jj_consume_token(IDENTIFIER);
                                                                                                                                                                                                                            identifier=new ASTStringNode(t.toString(),new WToken(t));
         {if (true) return new FunctionReturnType(text26, text27, text28, identifier, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public BlockOrSemi BlockOrSemi() throws ParseException {
    ...
    case SEMI:
      jj_consume_token(SEMI);
         {if (true) return new BlockOrSemi1(firstToken.next,token);}
      break;
    case OCB:
      block = Block();
         {if (true) return new BlockOrSemi2(block, firstToken.next,token);}
      break;
    case LITERAL:
    case PPLINE:
    case PPPRAGMA:
    ...
    case OTHER:
      ...
      block1 = Block();
         {if (true) return new BlockOrSemi3(varDeclList, block1, firstToken.next,token);}
      break;
    default:
      jj_la1[26] = jj_gen;
      jj_consume_token(-1);
  ...
  final public BlockAssignment BlockAssignment() throws ParseException {
    ...
    jj_consume_token(OCB);
    t = findEndCCB();
                                             findendccb=new ASTStringNode(t.toString(),new WToken(t));
  ...
  final public AnyStmtToken AnyStmtToken() throws ParseException {
    ...
    case COMMA:
      jj_consume_token(COMMA);
         {if (true) return new AnyStmtToken4(firstToken.next,token);}
      break;
    case PIPE:
      jj_consume_token(PIPE);
    ...
    case OCB:
      block = Block();
         {if (true) return new AnyStmtToken10(block, firstToken.next,token);}
      break;
    case IF:
      jj_consume_token(IF);
         {if (true) return new AnyStmtToken11(firstToken.next,token);}
      break;
    case ELSE:
      jj_consume_token(ELSE);
    ...
    default:
      ...
      if (jj_2_24(3)) {
        enumBlock = EnumBlock();
         {if (true) return new AnyStmtToken15(enumBlock, firstToken.next,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case ENUM:
          jj_consume_token(ENUM);
         {if (true) return new AnyStmtToken16(firstToken.next,token);}
          break;
        case STAR:
          jj_consume_token(STAR);
        ...
        default:
          ...
          if (jj_2_25(2147483647)) {
            blockAssignment = BlockAssignment();
         {if (true) return new AnyStmtToken18(blockAssignment, firstToken.next,token);}
          } else {
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
            case EQ:
              jj_consume_token(EQ);
         {if (true) return new AnyStmtToken19(firstToken.next,token);}
            ...
            case COLON:
              jj_consume_token(COLON);
         {if (true) return new AnyStmtToken20(firstToken.next,token);}
              break;
            case EXTERN:
            case STATIC:
            case INLINE:
            ...
            case WEIREDSTUFF2:
              modifier = Modifier();
         {if (true) return new AnyStmtToken21(modifier, firstToken.next,token);}
              break;
            case IFDEF:
              jj_consume_token(IFDEF);
         {if (true) return new AnyStmtToken22(firstToken.next,token);}
            ...
            case IFNDEF:
              jj_consume_token(IFNDEF);
         {if (true) return new AnyStmtToken23(firstToken.next,token);}
              break;
            case DEFINE:
              jj_consume_token(DEFINE);
         ...
         {if (true) return new AnyStmtToken27(firstToken.next,token);}
            ...
            case PPERROR:
              pPOtherIgnore = PPOtherIgnore();
         {if (true) return new AnyStmtToken28(pPOtherIgnore, firstToken.next,token);}
              break;
            case CONST:
              jj_consume_token(CONST);
         {if (true) return new AnyStmtToken29(firstToken.next,token);}
            ...
            case STRUCT:
              jj_consume_token(STRUCT);
         {if (true) return new AnyStmtToken30(firstToken.next,token);}
              break;
            case UNSIGNED:
              jj_consume_token(UNSIGNED);
  ...
  final public VarDeclToken VarDeclToken() throws ParseException {
    ...
    case OTHER:
      t = jj_consume_token(OTHER);
                  other=new ASTStringNode(t.toString(),new WToken(t));
         {if (true) return new VarDeclToken4(other, firstToken.next,token);}
      break;
    case PIPE:
      jj_consume_token(PIPE);
         {if (true) return new VarDeclToken5(firstToken.next,token);}
      break;
    case CONST:
      jj_consume_token(CONST);
         {if (true) return new VarDeclToken6(firstToken.next,token);}
      break;
    case STRUCT:
      jj_consume_token(STRUCT);
    ...
    case PPERROR:
      pPOtherIgnore = PPOtherIgnore();
         {if (true) return new VarDeclToken10(pPOtherIgnore, firstToken.next,token);}
      break;
    case EXTERN:
    case STATIC:
    case INLINE:
    ...
    case WEIREDSTUFF2:
      modifier = Modifier();
         {if (true) return new VarDeclToken11(modifier, firstToken.next,token);}
      break;
    case OB:
      jj_consume_token(OB);
      t = findEndCB();
                          findendcb=new ASTStringNode(t.toString(),new WToken(t));
         {if (true) return new VarDeclToken12(findendcb, firstToken.next,token);}
      break;
    default:
      jj_la1[39] = jj_gen;
      jj_consume_token(-1);
