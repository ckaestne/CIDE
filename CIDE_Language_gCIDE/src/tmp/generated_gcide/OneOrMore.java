...
public class OneOrMore extends GenASTNode {
  public OneOrMore(ArrayList<Text> text, Unit unit, ArrayList<Text> text1, Token firstToken, Token lastToken) {
    super(new Property[] {
  ...
  public OneOrMore(Property[] properties, IToken firstToken, IToken lastToken) {
    super(properties,firstToken,lastToken);
  }
  public IASTNode deepCopy() {
    return new OneOrMore(cloneProperties(),firstToken,lastToken);
  }
