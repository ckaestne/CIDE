 ...
 *******************************************************************************/
package de.ovgu.cide.astview.internal;
...
public class TreeCopyAction extends Action {
	...
	public TreeCopyAction(Tree[] trees) {
		...
		setEnabled(false);
		setImageDescriptor(CIDECorePlugin.getDefault().getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_COPY));
