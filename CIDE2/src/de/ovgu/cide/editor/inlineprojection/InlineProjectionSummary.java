...
class InlineProjectionSummary  {
	...
	private InlineProjectionSourceViewer fProjectionViewer;
	 ...
	 */
	public InlineProjectionSummary(InlineProjectionSourceViewer projectionViewer, IAnnotationAccess annotationAccess) {
		super();
	...
	private void createSummaries(IProgressMonitor monitor) {
		InlineProjectionAnnotationModel model= fProjectionViewer.getInlineProjectionAnnotationModel();
		if (model == null)
			return;
		...
		while (e.hasNext()) {
			InlineProjectionAnnotation projection= (InlineProjectionAnnotation) e.next();
