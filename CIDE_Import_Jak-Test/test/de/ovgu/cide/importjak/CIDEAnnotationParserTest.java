...
public class CIDEAnnotationParserTest extends TestCase {
	...
	public void testParseFeatures() {
		String ifdef = FeatureJavaPrintVisitor.startIfdef(new Or(new Literal("A"),new Literal("B"),new Literal("XX")));
		Collection<String> r = new CIDEAnnotationParser().parseFeatures(ifdef, 0);
