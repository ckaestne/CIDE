...
public class MemberValueArrayInitializer extends GenASTNode {
  public MemberValueArrayInitializer(MemberValue memberValue, ArrayList<MemberValue> memberValue1, ASTTextNode text456, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<MemberValue>("memberValue", memberValue),
      new PropertyZeroOrMore<MemberValue>("memberValue1", memberValue1),
      new PropertyZeroOrOne<ASTTextNode>("text456", text456)
  ...
  public ASTTextNode getText456() {
    return ((PropertyZeroOrOne<ASTTextNode>)getProperty("text456")).getValue();
  }
}
