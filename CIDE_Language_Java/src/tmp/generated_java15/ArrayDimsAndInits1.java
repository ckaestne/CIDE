...
public class ArrayDimsAndInits1 extends ArrayDimsAndInits {
  public ArrayDimsAndInits1(Expression expression, ArrayList<Expression> expression1, ArrayList<ASTTextNode> text448, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<Expression>("expression", expression),
      new PropertyZeroOrMore<Expression>("expression1", expression1),
      new PropertyZeroOrMore<ASTTextNode>("text448", text448)
  ...
  public ArrayList<ASTTextNode> getText448() {
    return ((PropertyZeroOrMore<ASTTextNode>)getProperty("text448")).getValue();
  }
}
