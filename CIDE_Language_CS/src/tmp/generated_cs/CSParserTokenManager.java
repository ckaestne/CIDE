/* Generated By:JavaCC: Do not edit this line. CSParserTokenManager.java */
...
import cide.gparser.*;
import cide.gparser.*;
public class CSParserTokenManager implements CSParserConstants
{
...
public CSParserTokenManager(CharStream stream){
   input_stream = stream;
}
public CSParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
