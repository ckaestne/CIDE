...
public class Element_dd2 extends Element_dd {
  public Element_dd2(STag_dd sTag_dd, ArrayList<CMisc> cMisc1, ArrayList<Content_dd_Seq1> content_dd_Seq1, ETag_dd eTag_dd, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_dd>("sTag_dd", sTag_dd),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_dd_Seq1>("content_dd_Seq1", content_dd_Seq1),
  ...
  public ArrayList<Content_dd_Seq1> getContent_dd_Seq1() {
    return ((PropertyZeroOrMore<Content_dd_Seq1>)getProperty("content_dd_Seq1")).getValue();
  }
