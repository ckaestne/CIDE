...
public class Element_ins2 extends Element_ins {
  public Element_ins2(STag_ins sTag_ins, ArrayList<CMisc> cMisc1, ArrayList<Content_ins_Seq1> content_ins_Seq1, ETag_ins eTag_ins, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_ins>("sTag_ins", sTag_ins),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_ins_Seq1>("content_ins_Seq1", content_ins_Seq1),
  ...
  public ArrayList<Content_ins_Seq1> getContent_ins_Seq1() {
    return ((PropertyZeroOrMore<Content_ins_Seq1>)getProperty("content_ins_Seq1")).getValue();
  }
