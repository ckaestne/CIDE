...
public class Element_cite2 extends Element_cite {
  public Element_cite2(STag_cite sTag_cite, ArrayList<CMisc> cMisc1, ArrayList<Content_cite_Seq1> content_cite_Seq1, ETag_cite eTag_cite, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_cite>("sTag_cite", sTag_cite),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_cite_Seq1>("content_cite_Seq1", content_cite_Seq1),
  ...
  public ArrayList<Content_cite_Seq1> getContent_cite_Seq1() {
    return ((PropertyZeroOrMore<Content_cite_Seq1>)getProperty("content_cite_Seq1")).getValue();
  }
