...
public class Element_dt2 extends Element_dt {
  public Element_dt2(STag_dt sTag_dt, ArrayList<CMisc> cMisc1, ArrayList<Content_dt_Seq1> content_dt_Seq1, ETag_dt eTag_dt, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_dt>("sTag_dt", sTag_dt),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_dt_Seq1>("content_dt_Seq1", content_dt_Seq1),
  ...
  public ArrayList<Content_dt_Seq1> getContent_dt_Seq1() {
    return ((PropertyZeroOrMore<Content_dt_Seq1>)getProperty("content_dt_Seq1")).getValue();
  }
