...
public class Element_li2 extends Element_li {
  public Element_li2(STag_li sTag_li, ArrayList<CMisc> cMisc1, ArrayList<Content_li_Seq1> content_li_Seq1, ETag_li eTag_li, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_li>("sTag_li", sTag_li),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_li_Seq1>("content_li_Seq1", content_li_Seq1),
  ...
  public ArrayList<Content_li_Seq1> getContent_li_Seq1() {
    return ((PropertyZeroOrMore<Content_li_Seq1>)getProperty("content_li_Seq1")).getValue();
  }
