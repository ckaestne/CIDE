...
public class Element_sub2 extends Element_sub {
  public Element_sub2(STag_sub sTag_sub, ArrayList<CMisc> cMisc1, ArrayList<Content_sub_Seq1> content_sub_Seq1, ETag_sub eTag_sub, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_sub>("sTag_sub", sTag_sub),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_sub_Seq1>("content_sub_Seq1", content_sub_Seq1),
  ...
  public ArrayList<Content_sub_Seq1> getContent_sub_Seq1() {
    return ((PropertyZeroOrMore<Content_sub_Seq1>)getProperty("content_sub_Seq1")).getValue();
  }
