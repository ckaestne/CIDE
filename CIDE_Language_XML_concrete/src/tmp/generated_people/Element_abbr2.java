...
public class Element_abbr2 extends Element_abbr {
  public Element_abbr2(STag_abbr sTag_abbr, ArrayList<CMisc> cMisc1, ArrayList<Content_abbr_Seq1> content_abbr_Seq1, ETag_abbr eTag_abbr, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_abbr>("sTag_abbr", sTag_abbr),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_abbr_Seq1>("content_abbr_Seq1", content_abbr_Seq1),
  ...
  public ArrayList<Content_abbr_Seq1> getContent_abbr_Seq1() {
    return ((PropertyZeroOrMore<Content_abbr_Seq1>)getProperty("content_abbr_Seq1")).getValue();
  }
