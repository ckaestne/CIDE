...
public class Element_h22 extends Element_h2 {
  public Element_h22(STag_h2 sTag_h2, ArrayList<CMisc> cMisc1, ArrayList<Content_h2_Seq1> content_h2_Seq1, ETag_h2 eTag_h2, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h2>("sTag_h2", sTag_h2),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h2_Seq1>("content_h2_Seq1", content_h2_Seq1),
  ...
  public ArrayList<Content_h2_Seq1> getContent_h2_Seq1() {
    return ((PropertyZeroOrMore<Content_h2_Seq1>)getProperty("content_h2_Seq1")).getValue();
  }
