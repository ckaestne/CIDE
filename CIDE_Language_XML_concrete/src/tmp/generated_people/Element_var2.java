...
public class Element_var2 extends Element_var {
  public Element_var2(STag_var sTag_var, ArrayList<CMisc> cMisc1, ArrayList<Content_var_Seq1> content_var_Seq1, ETag_var eTag_var, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_var>("sTag_var", sTag_var),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_var_Seq1>("content_var_Seq1", content_var_Seq1),
  ...
  public ArrayList<Content_var_Seq1> getContent_var_Seq1() {
    return ((PropertyZeroOrMore<Content_var_Seq1>)getProperty("content_var_Seq1")).getValue();
  }
