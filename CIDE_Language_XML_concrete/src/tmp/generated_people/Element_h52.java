...
public class Element_h52 extends Element_h5 {
  public Element_h52(STag_h5 sTag_h5, ArrayList<CMisc> cMisc1, ArrayList<Content_h5_Seq1> content_h5_Seq1, ETag_h5 eTag_h5, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h5>("sTag_h5", sTag_h5),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h5_Seq1>("content_h5_Seq1", content_h5_Seq1),
  ...
  public ArrayList<Content_h5_Seq1> getContent_h5_Seq1() {
    return ((PropertyZeroOrMore<Content_h5_Seq1>)getProperty("content_h5_Seq1")).getValue();
  }
