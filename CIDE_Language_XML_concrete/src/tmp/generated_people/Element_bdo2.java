...
public class Element_bdo2 extends Element_bdo {
  public Element_bdo2(STag_bdo sTag_bdo, ArrayList<CMisc> cMisc1, ArrayList<Content_bdo_Seq1> content_bdo_Seq1, ETag_bdo eTag_bdo, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_bdo>("sTag_bdo", sTag_bdo),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_bdo_Seq1>("content_bdo_Seq1", content_bdo_Seq1),
  ...
  public ArrayList<Content_bdo_Seq1> getContent_bdo_Seq1() {
    return ((PropertyZeroOrMore<Content_bdo_Seq1>)getProperty("content_bdo_Seq1")).getValue();
  }
