...
public class Element_label2 extends Element_label {
  public Element_label2(STag_label sTag_label, ArrayList<CMisc> cMisc1, ArrayList<Content_label_Seq1> content_label_Seq1, ETag_label eTag_label, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_label>("sTag_label", sTag_label),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_label_Seq1>("content_label_Seq1", content_label_Seq1),
  ...
  public ArrayList<Content_label_Seq1> getContent_label_Seq1() {
    return ((PropertyZeroOrMore<Content_label_Seq1>)getProperty("content_label_Seq1")).getValue();
  }
