...
public class Element_legend2 extends Element_legend {
  public Element_legend2(STag_legend sTag_legend, ArrayList<CMisc> cMisc1, ArrayList<Content_legend_Seq1> content_legend_Seq1, ETag_legend eTag_legend, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_legend>("sTag_legend", sTag_legend),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_legend_Seq1>("content_legend_Seq1", content_legend_Seq1),
  ...
  public ArrayList<Content_legend_Seq1> getContent_legend_Seq1() {
    return ((PropertyZeroOrMore<Content_legend_Seq1>)getProperty("content_legend_Seq1")).getValue();
  }
