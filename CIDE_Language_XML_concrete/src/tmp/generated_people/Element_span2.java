...
public class Element_span2 extends Element_span {
  public Element_span2(STag_span sTag_span, ArrayList<CMisc> cMisc1, ArrayList<Content_span_Seq1> content_span_Seq1, ETag_span eTag_span, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_span>("sTag_span", sTag_span),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_span_Seq1>("content_span_Seq1", content_span_Seq1),
  ...
  public ArrayList<Content_span_Seq1> getContent_span_Seq1() {
    return ((PropertyZeroOrMore<Content_span_Seq1>)getProperty("content_span_Seq1")).getValue();
  }
