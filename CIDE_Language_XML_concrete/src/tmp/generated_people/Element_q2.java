...
public class Element_q2 extends Element_q {
  public Element_q2(STag_q sTag_q, ArrayList<CMisc> cMisc1, ArrayList<Content_q_Seq1> content_q_Seq1, ETag_q eTag_q, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_q>("sTag_q", sTag_q),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_q_Seq1>("content_q_Seq1", content_q_Seq1),
  ...
  public ArrayList<Content_q_Seq1> getContent_q_Seq1() {
    return ((PropertyZeroOrMore<Content_q_Seq1>)getProperty("content_q_Seq1")).getValue();
  }
