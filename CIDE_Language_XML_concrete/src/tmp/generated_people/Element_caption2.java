...
public class Element_caption2 extends Element_caption {
  public Element_caption2(STag_caption sTag_caption, ArrayList<CMisc> cMisc1, ArrayList<Content_caption_Seq1> content_caption_Seq1, ETag_caption eTag_caption, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_caption>("sTag_caption", sTag_caption),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_caption_Seq1>("content_caption_Seq1", content_caption_Seq1),
  ...
  public ArrayList<Content_caption_Seq1> getContent_caption_Seq1() {
    return ((PropertyZeroOrMore<Content_caption_Seq1>)getProperty("content_caption_Seq1")).getValue();
  }
