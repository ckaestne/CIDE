...
public class Element_del2 extends Element_del {
  public Element_del2(STag_del sTag_del, ArrayList<CMisc> cMisc1, ArrayList<Content_del_Seq1> content_del_Seq1, ETag_del eTag_del, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_del>("sTag_del", sTag_del),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_del_Seq1>("content_del_Seq1", content_del_Seq1),
  ...
  public ArrayList<Content_del_Seq1> getContent_del_Seq1() {
    return ((PropertyZeroOrMore<Content_del_Seq1>)getProperty("content_del_Seq1")).getValue();
  }
