...
public class Content_pre_Seq1 extends GenASTNode {
  public Content_pre_Seq1(ASTStringNode pcdata, Element_a element_a, Element_tt element_tt, Element_i element_i, Element_b element_b, Element_big element_big, Element_small element_small, Element_em element_em, Element_strong element_strong, Element_dfn element_dfn, Element_code element_code, Element_q element_q, Element_samp element_samp, Element_kbd element_kbd, Element_var element_var, Element_cite element_cite, Element_abbr element_abbr, Element_acronym element_acronym, Element_sub element_sub, Element_sup element_sup, Element_br element_br, Element_span element_span, Element_bdo element_bdo, Element_map element_map, Element_ins element_ins, Element_del element_del, Element_script element_script, Element_input element_input, Element_select element_select, Element_textarea element_textarea, Element_label element_label, Element_button element_button, Token firstToken, Token lastToken) {
    super(new Property[] {
  ...
  public Content_pre_Seq1(Property[] properties, IToken firstToken, IToken lastToken) {
    super(properties,firstToken,lastToken);
  }
  public ASTNode deepCopy() {
    return new Content_pre_Seq1(cloneProperties(),firstToken,lastToken);
  }
