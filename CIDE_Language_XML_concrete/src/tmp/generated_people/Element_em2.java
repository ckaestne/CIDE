...
public class Element_em2 extends Element_em {
  public Element_em2(STag_em sTag_em, ArrayList<CMisc> cMisc1, ArrayList<Content_em_Seq1> content_em_Seq1, ETag_em eTag_em, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_em>("sTag_em", sTag_em),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_em_Seq1>("content_em_Seq1", content_em_Seq1),
  ...
  public ArrayList<Content_em_Seq1> getContent_em_Seq1() {
    return ((PropertyZeroOrMore<Content_em_Seq1>)getProperty("content_em_Seq1")).getValue();
  }
