...
public class Element_i2 extends Element_i {
  public Element_i2(STag_i sTag_i, ArrayList<CMisc> cMisc1, ArrayList<Content_i_Seq1> content_i_Seq1, ETag_i eTag_i, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_i>("sTag_i", sTag_i),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_i_Seq1>("content_i_Seq1", content_i_Seq1),
  ...
  public ArrayList<Content_i_Seq1> getContent_i_Seq1() {
    return ((PropertyZeroOrMore<Content_i_Seq1>)getProperty("content_i_Seq1")).getValue();
  }
