...
public class Content_button_Seq1 extends GenASTNode {
  public Content_button_Seq1(ASTStringNode pcdata, Element_p element_p, Element_h1 element_h1, Element_h2 element_h2, Element_h3 element_h3, Element_h4 element_h4, Element_h5 element_h5, Element_h6 element_h6, Element_div element_div, Element_ul element_ul, Element_ol element_ol, Element_dl element_dl, Element_pre element_pre, Element_hr element_hr, Element_blockquote element_blockquote, Element_address element_address, Element_table element_table, Element_br element_br, Element_span element_span, Element_bdo element_bdo, Element_map element_map, Element_object element_object, Element_img element_img, Element_tt element_tt, Element_i element_i, Element_b element_b, Element_big element_big, Element_small element_small, Element_em element_em, Element_strong element_strong, Element_dfn element_dfn, Element_code element_code, Element_q element_q, Element_samp element_samp, Element_kbd element_kbd, Element_var element_var, Element_cite element_cite, Element_abbr element_abbr, Element_acronym element_acronym, Element_sub element_sub, Element_sup element_sup, Element_noscript element_noscript, Element_ins element_ins, Element_del element_del, Element_script element_script, Token firstToken, Token lastToken) {
    super(new Property[] {
  ...
  public Content_button_Seq1(Property[] properties, IToken firstToken, IToken lastToken) {
    super(properties,firstToken,lastToken);
  }
  public ASTNode deepCopy() {
    return new Content_button_Seq1(cloneProperties(),firstToken,lastToken);
  }
