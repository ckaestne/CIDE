...
public class Element_h32 extends Element_h3 {
  public Element_h32(STag_h3 sTag_h3, ArrayList<CMisc> cMisc1, ArrayList<Content_h3_Seq1> content_h3_Seq1, ETag_h3 eTag_h3, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h3>("sTag_h3", sTag_h3),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h3_Seq1>("content_h3_Seq1", content_h3_Seq1),
  ...
  public ArrayList<Content_h3_Seq1> getContent_h3_Seq1() {
    return ((PropertyZeroOrMore<Content_h3_Seq1>)getProperty("content_h3_Seq1")).getValue();
  }
