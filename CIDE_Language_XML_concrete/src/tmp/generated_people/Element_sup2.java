...
public class Element_sup2 extends Element_sup {
  public Element_sup2(STag_sup sTag_sup, ArrayList<CMisc> cMisc1, ArrayList<Content_sup_Seq1> content_sup_Seq1, ETag_sup eTag_sup, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_sup>("sTag_sup", sTag_sup),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_sup_Seq1>("content_sup_Seq1", content_sup_Seq1),
  ...
  public ArrayList<Content_sup_Seq1> getContent_sup_Seq1() {
    return ((PropertyZeroOrMore<Content_sup_Seq1>)getProperty("content_sup_Seq1")).getValue();
  }
