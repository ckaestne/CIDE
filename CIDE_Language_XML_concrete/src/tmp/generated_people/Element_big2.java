...
public class Element_big2 extends Element_big {
  public Element_big2(STag_big sTag_big, ArrayList<CMisc> cMisc1, ArrayList<Content_big_Seq1> content_big_Seq1, ETag_big eTag_big, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_big>("sTag_big", sTag_big),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_big_Seq1>("content_big_Seq1", content_big_Seq1),
  ...
  public ArrayList<Content_big_Seq1> getContent_big_Seq1() {
    return ((PropertyZeroOrMore<Content_big_Seq1>)getProperty("content_big_Seq1")).getValue();
  }
