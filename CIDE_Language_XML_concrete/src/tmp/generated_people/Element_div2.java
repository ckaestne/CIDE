...
public class Element_div2 extends Element_div {
  public Element_div2(STag_div sTag_div, ArrayList<CMisc> cMisc1, ArrayList<Content_div_Seq1> content_div_Seq1, ETag_div eTag_div, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_div>("sTag_div", sTag_div),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_div_Seq1>("content_div_Seq1", content_div_Seq1),
  ...
  public ArrayList<Content_div_Seq1> getContent_div_Seq1() {
    return ((PropertyZeroOrMore<Content_div_Seq1>)getProperty("content_div_Seq1")).getValue();
  }
