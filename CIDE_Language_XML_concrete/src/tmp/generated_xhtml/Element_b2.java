...
public class Element_b2 extends Element_b {
  public Element_b2(STag_b sTag_b, ArrayList<CMisc> cMisc1, ArrayList<Content_b_Choice1> content_b_Choice1, ETag_b eTag_b, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_b>("sTag_b", sTag_b),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_b_Choice1>("content_b_Choice1", content_b_Choice1),
  ...
  public ArrayList<Content_b_Choice1> getContent_b_Choice1() {
    return ((PropertyZeroOrMore<Content_b_Choice1>)getProperty("content_b_Choice1")).getValue();
  }
