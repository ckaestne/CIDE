...
public class Element_samp2 extends Element_samp {
  public Element_samp2(STag_samp sTag_samp, ArrayList<CMisc> cMisc1, ArrayList<Content_samp_Choice1> content_samp_Choice1, ETag_samp eTag_samp, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_samp>("sTag_samp", sTag_samp),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_samp_Choice1>("content_samp_Choice1", content_samp_Choice1),
  ...
  public ArrayList<Content_samp_Choice1> getContent_samp_Choice1() {
    return ((PropertyZeroOrMore<Content_samp_Choice1>)getProperty("content_samp_Choice1")).getValue();
  }
