...
public class Element_strong2 extends Element_strong {
  public Element_strong2(STag_strong sTag_strong, ArrayList<CMisc> cMisc1, ArrayList<Content_strong_Choice1> content_strong_Choice1, ETag_strong eTag_strong, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_strong>("sTag_strong", sTag_strong),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_strong_Choice1>("content_strong_Choice1", content_strong_Choice1),
  ...
  public ArrayList<Content_strong_Choice1> getContent_strong_Choice1() {
    return ((PropertyZeroOrMore<Content_strong_Choice1>)getProperty("content_strong_Choice1")).getValue();
  }
