...
public class Element_small2 extends Element_small {
  public Element_small2(STag_small sTag_small, ArrayList<CMisc> cMisc1, ArrayList<Content_small_Choice1> content_small_Choice1, ETag_small eTag_small, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_small>("sTag_small", sTag_small),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_small_Choice1>("content_small_Choice1", content_small_Choice1),
  ...
  public ArrayList<Content_small_Choice1> getContent_small_Choice1() {
    return ((PropertyZeroOrMore<Content_small_Choice1>)getProperty("content_small_Choice1")).getValue();
  }
