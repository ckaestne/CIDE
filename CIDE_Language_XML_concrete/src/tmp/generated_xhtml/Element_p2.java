...
public class Element_p2 extends Element_p {
  public Element_p2(STag_p sTag_p, ArrayList<CMisc> cMisc1, ArrayList<Content_p_Choice1> content_p_Choice1, ETag_p eTag_p, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_p>("sTag_p", sTag_p),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_p_Choice1>("content_p_Choice1", content_p_Choice1),
  ...
  public ArrayList<Content_p_Choice1> getContent_p_Choice1() {
    return ((PropertyZeroOrMore<Content_p_Choice1>)getProperty("content_p_Choice1")).getValue();
  }
