...
public class Element_dfn2 extends Element_dfn {
  public Element_dfn2(STag_dfn sTag_dfn, ArrayList<CMisc> cMisc1, ArrayList<Content_dfn_Choice1> content_dfn_Choice1, ETag_dfn eTag_dfn, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_dfn>("sTag_dfn", sTag_dfn),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_dfn_Choice1>("content_dfn_Choice1", content_dfn_Choice1),
  ...
  public ArrayList<Content_dfn_Choice1> getContent_dfn_Choice1() {
    return ((PropertyZeroOrMore<Content_dfn_Choice1>)getProperty("content_dfn_Choice1")).getValue();
  }
