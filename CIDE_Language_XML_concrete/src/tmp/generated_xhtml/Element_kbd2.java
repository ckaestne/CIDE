...
public class Element_kbd2 extends Element_kbd {
  public Element_kbd2(STag_kbd sTag_kbd, ArrayList<CMisc> cMisc1, ArrayList<Content_kbd_Choice1> content_kbd_Choice1, ETag_kbd eTag_kbd, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_kbd>("sTag_kbd", sTag_kbd),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_kbd_Choice1>("content_kbd_Choice1", content_kbd_Choice1),
  ...
  public ArrayList<Content_kbd_Choice1> getContent_kbd_Choice1() {
    return ((PropertyZeroOrMore<Content_kbd_Choice1>)getProperty("content_kbd_Choice1")).getValue();
  }
