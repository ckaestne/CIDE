...
public class Element_fieldset2 extends Element_fieldset {
  public Element_fieldset2(STag_fieldset sTag_fieldset, ArrayList<CMisc> cMisc1, ArrayList<Content_fieldset_Choice1> content_fieldset_Choice1, ETag_fieldset eTag_fieldset, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_fieldset>("sTag_fieldset", sTag_fieldset),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_fieldset_Choice1>("content_fieldset_Choice1", content_fieldset_Choice1),
  ...
  public ArrayList<Content_fieldset_Choice1> getContent_fieldset_Choice1() {
    return ((PropertyZeroOrMore<Content_fieldset_Choice1>)getProperty("content_fieldset_Choice1")).getValue();
  }
