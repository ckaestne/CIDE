...
public class Element_code2 extends Element_code {
  public Element_code2(STag_code sTag_code, ArrayList<CMisc> cMisc1, ArrayList<Content_code_Choice1> content_code_Choice1, ETag_code eTag_code, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_code>("sTag_code", sTag_code),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_code_Choice1>("content_code_Choice1", content_code_Choice1),
  ...
  public ArrayList<Content_code_Choice1> getContent_code_Choice1() {
    return ((PropertyZeroOrMore<Content_code_Choice1>)getProperty("content_code_Choice1")).getValue();
  }
