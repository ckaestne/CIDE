...
public class Element_td2 extends Element_td {
  public Element_td2(STag_td sTag_td, ArrayList<CMisc> cMisc1, ArrayList<Content_td_Choice1> content_td_Choice1, ETag_td eTag_td, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_td>("sTag_td", sTag_td),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_td_Choice1>("content_td_Choice1", content_td_Choice1),
  ...
  public ArrayList<Content_td_Choice1> getContent_td_Choice1() {
    return ((PropertyZeroOrMore<Content_td_Choice1>)getProperty("content_td_Choice1")).getValue();
  }
