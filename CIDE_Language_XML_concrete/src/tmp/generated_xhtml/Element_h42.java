...
public class Element_h42 extends Element_h4 {
  public Element_h42(STag_h4 sTag_h4, ArrayList<CMisc> cMisc1, ArrayList<Content_h4_Choice1> content_h4_Choice1, ETag_h4 eTag_h4, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h4>("sTag_h4", sTag_h4),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h4_Choice1>("content_h4_Choice1", content_h4_Choice1),
  ...
  public ArrayList<Content_h4_Choice1> getContent_h4_Choice1() {
    return ((PropertyZeroOrMore<Content_h4_Choice1>)getProperty("content_h4_Choice1")).getValue();
  }
