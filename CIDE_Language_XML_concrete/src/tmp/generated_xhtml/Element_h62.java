...
public class Element_h62 extends Element_h6 {
  public Element_h62(STag_h6 sTag_h6, ArrayList<CMisc> cMisc1, ArrayList<Content_h6_Choice1> content_h6_Choice1, ETag_h6 eTag_h6, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h6>("sTag_h6", sTag_h6),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h6_Choice1>("content_h6_Choice1", content_h6_Choice1),
  ...
  public ArrayList<Content_h6_Choice1> getContent_h6_Choice1() {
    return ((PropertyZeroOrMore<Content_h6_Choice1>)getProperty("content_h6_Choice1")).getValue();
  }
