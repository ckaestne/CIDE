...
public class Element_th2 extends Element_th {
  public Element_th2(STag_th sTag_th, ArrayList<CMisc> cMisc1, ArrayList<Content_th_Choice1> content_th_Choice1, ETag_th eTag_th, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_th>("sTag_th", sTag_th),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_th_Choice1>("content_th_Choice1", content_th_Choice1),
  ...
  public ArrayList<Content_th_Choice1> getContent_th_Choice1() {
    return ((PropertyZeroOrMore<Content_th_Choice1>)getProperty("content_th_Choice1")).getValue();
  }
