...
public class Element_h12 extends Element_h1 {
  public Element_h12(STag_h1 sTag_h1, ArrayList<CMisc> cMisc1, ArrayList<Content_h1_Choice1> content_h1_Choice1, ETag_h1 eTag_h1, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_h1>("sTag_h1", sTag_h1),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_h1_Choice1>("content_h1_Choice1", content_h1_Choice1),
  ...
  public ArrayList<Content_h1_Choice1> getContent_h1_Choice1() {
    return ((PropertyZeroOrMore<Content_h1_Choice1>)getProperty("content_h1_Choice1")).getValue();
  }
