...
public class Element_acronym2 extends Element_acronym {
  public Element_acronym2(STag_acronym sTag_acronym, ArrayList<CMisc> cMisc1, ArrayList<Content_acronym_Choice1> content_acronym_Choice1, ETag_acronym eTag_acronym, ArrayList<CMisc> cMisc2, Token firstToken, Token lastToken) {
    super(new Property[] {
      new PropertyOne<STag_acronym>("sTag_acronym", sTag_acronym),
      new PropertyZeroOrMore<CMisc>("cMisc1", cMisc1),
      new PropertyZeroOrMore<Content_acronym_Choice1>("content_acronym_Choice1", content_acronym_Choice1),
  ...
  public ArrayList<Content_acronym_Choice1> getContent_acronym_Choice1() {
    return ((PropertyZeroOrMore<Content_acronym_Choice1>)getProperty("content_acronym_Choice1")).getValue();
  }
