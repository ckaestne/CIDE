...
public class JakHookMethodHelper {
	...
	JakHookMethodHelper(List<Statement> statements,
			Statement subtreeRuleException, RefactoringColorManager colorManager) {
	...
	private List<Name> thrownExceptions;
	...
	private List<Name> calcThrownExceptions(MethodDeclaration method,
