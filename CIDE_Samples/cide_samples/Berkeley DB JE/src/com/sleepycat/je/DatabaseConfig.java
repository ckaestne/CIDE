 ...
 *
 * $Id: DatabaseConfig.java,v 1.1 2006/05/06 08:59:26 ckaestne Exp $
 */
...
public class DatabaseConfig implements Cloneable {
	...
	void validate(DatabaseConfig config) throws DatabaseException {
		...
		if (txnMatch && roMatch && sdMatch && btCmpMatch && dtCmpMatch) {
			...
			String message = genDatabaseConfigMismatchMessage(config, txnMatch,
	...
	String genDatabaseConfigMismatchMessage(DatabaseConfig config,
			boolean txnMatch, boolean roMatch, boolean sdMatch,
