...
import cide.gparser.WToken;
  ...
  final public exports exports() throws ParseException {
    ...
    case COMMA:
      jj_consume_token(COMMA);
                                              text363=new ASTTextNode(",",new WToken(token));
      break;
    default:
      jj_la1[2] = jj_gen;
      ;
    ...
    jj_consume_token(RIGHT_PAREN);
         {if (true) return new exports(exportsList, text363, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case IMPORT:
      ...
      case QUALIFIED:
        jj_consume_token(QUALIFIED);
                               text365=new ASTTextNode("qualified",new WToken(token));
        break;
      default:
        jj_la1[12] = jj_gen;
        ;
      ...
      default:
        ...
        ;
         ...
         {if (true) return new impdecl1(text365, modid, modid1, impspec, firstToken.next,token);}
      break;
    default:
      jj_la1[15] = jj_gen;
  ...
  final public impspec impspec() throws ParseException {
        ASTTextNode text367 = null;
        imports imports = null;
        Token firstToken=token;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case HIDING:
      jj_consume_token(HIDING);
                   text367=new ASTTextNode("hiding",new WToken(token));
      break;
    default:
      jj_la1[16] = jj_gen;
      ;
    ...
    jj_consume_token(RIGHT_PAREN);
         {if (true) return new impspec(text367, imports, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
