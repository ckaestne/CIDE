...
import cide.gparser.WToken;
  ...
  final public exports exports() throws ParseException {
    ...
    jj_consume_token(RIGHT_PAREN);
         {if (true) return new exports(exportList, text1, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public importDecl importDecl() throws ParseException {
    ...
    case QUALIFIED:
      jj_consume_token(QUALIFIED);
                               text2=new ASTTextNode("qualified",new WToken(token));
      break;
    default:
      jj_la1[7] = jj_gen;
      ;
    ...
    default:
      ...
      ;
         ...
         {if (true) return new importDecl(text2, naam, naam1, hiding, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public hiding hiding() throws ParseException {
    ...
    case HIDING:
      jj_consume_token(HIDING);
                   text3=new ASTTextNode("hiding",new WToken(token));
      break;
    default:
      jj_la1[10] = jj_gen;
      ;
    ...
    jj_consume_token(RIGHT_PAREN);
         {if (true) return new hiding(text3, exportList, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public patroonMain patroonMain() throws ParseException {
    ...
    case STRING_LITERAL:
      ...
      literal = literal();
         {if (true) return new patroonMain2(text7, literal, firstToken.next,token);}
      break;
    default:
      jj_la1[81] = jj_gen;
