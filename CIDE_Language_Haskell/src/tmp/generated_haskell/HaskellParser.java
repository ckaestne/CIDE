...
import cide.gparser.*;
  ...
  final public exports exports() throws ParseException {
    ...
    jj_consume_token(RIGHT_PAREN);
         {if (true) return new exports(exportList, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case CLASS:
      ...
      default:
        ...
        ;
         ...
         {if (true) return new classdecl(context2, naam1, var, whereDecls, firstToken.next,token);}
      break;
    case INSTANCE:
      ...
      default:
        ...
        ;
         ...
         {if (true) return new instancedecl(context3, naam2, inst, whereDecls1, firstToken.next,token);}
      break;
    case DEFAULTTOKEN:
  ...
  final public constr constr() throws ParseException {
        naam naam;
        vt vt;
        ArrayList<vt> list0=new ArrayList<vt>();
        vt vt1;
        ArrayList<vt> vt1List = new ArrayList<vt>();
        type type;
  ...
  final public vt vt() throws ParseException {
        varList varList;
        functiontype functiontype;
        Token firstToken=token;
    varList = varList();
    ...
    functiontype = functiontype();
         {if (true) return new vt(varList, functiontype, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public inst inst() throws ParseException {
        ...
        var var3;
        ArrayList<var> var3List = new ArrayList<var>();
    ...
    case INFIX_QUOTE:
      naam = naam();
         {if (true) return new inst1(naam, firstToken.next,token);}
      break;
    default:
      jj_la1[34] = jj_gen;
      if (jj_2_13(2147483647)) {
        ...
        var1 = var();
        jj_consume_token(RIGHT_PAREN);
         {if (true) return new inst2(var, var1, firstToken.next,token);}
        ...
        jj_consume_token(RIGHT_PAREN);
         {if (true) return new inst3(list2, firstToken.next,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LEFT_PAREN:
          jj_consume_token(LEFT_PAREN);
          ...
          jj_consume_token(RIGHT_PAREN);
         {if (true) return new inst4(simpletype, firstToken.next,token);}
          break;
        case LEFT_BRACKET:
          jj_consume_token(LEFT_BRACKET);
          var4 = var();
          jj_consume_token(RIGHT_BRACKET);
         {if (true) return new inst5(var4, firstToken.next,token);}
          break;
        default:
          jj_la1[35] = jj_gen;
          jj_consume_token(-1);
    ...
    if (jj_2_16(2147483647)) {
      ...
      default:
        ...
        ;
         ...
         {if (true) return new declaration3(patr, expr1, whereDecls2, firstToken.next,token);}
      ...
      default:
        ...
        ;
         ...
         {if (true) return new declaration4(patr1, altExprAss1List, whereDecls3, firstToken.next,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CONSTRUCTOR_ID:
      case VARIABLE_ID:
      case INFIX_QUOTE:
        ...
        functiontype = functiontype();
         {if (true) return new declaration5(varList, context, functiontype, firstToken.next,token);}
        break;
      case INFIX:
    ...
    if (jj_2_20(2147483647)) {
      ...
      while (true) {
        ...
        default:
         ...
         {if (true) return new function1(var, patroonList, firstToken.next,token);}
      ...
      while (true) {
        ...
        default:
         ...
         {if (true) return new function2(function, patroon1List, firstToken.next,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OTHER2:
      case OTHER4:
      ...
      case INFIX_QUOTE:
        ...
        operator = operator();
        patr = patr();
         {if (true) return new function3(patroon2, operator, patr, firstToken.next,token);}
        break;
      default:
        jj_la1[50] = jj_gen;
        jj_consume_token(-1);
      ...
      if (jj_2_22(2147483647)) {
        ...
        default:
          ...
          if (jj_2_23(2147483647)) {
            ...
            expr = expr();
            jj_consume_token(RIGHT_PAREN);
         {if (true) return new expressie4(operator, expr, firstToken.next,token);}
          } else if (jj_2_24(2147483647)) {
            jj_consume_token(LEFT_PAREN);
            expr1 = expr();
            operator1 = operator();
            jj_consume_token(RIGHT_PAREN);
         {if (true) return new expressie5(expr1, operator1, firstToken.next,token);}
          } else {
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
            case LEFT_PAREN:
              jj_consume_token(LEFT_PAREN);
         ...
         {if (true) return new expressie6(exprList, firstToken.next,token);}
            ...
            case LEFT_BRACKET:
              ...
              jj_consume_token(RIGHT_BRACKET);
         {if (true) return new expressie7(exprListSpecial, firstToken.next,token);}
              break;
            default:
              jj_la1[57] = jj_gen;
              jj_consume_token(-1);
    ...
    case INFIX_QUOTE:
      ...
      while (true) {
        ...
        default:
         ...
         {if (true) return new exprMain1(expressieList, firstToken.next,token);}
      break;
    case OTHER2:
    ...
    if (jj_2_27(2147483647)) {
      ...
      case INFIX_QUOTE:
        ...
        while (true) {
         ...
         {if (true) return new exprListSpecial3(expr4, expr5List, firstToken.next,token);}
        break;
      default:
        jj_la1[68] = jj_gen;
        jj_consume_token(-1);
  ...
  final public patrOp patrOp() throws ParseException {
    ...
    constructorOperator = constructorOperator();
    patr = patr();
         {if (true) return new patrOp(constructorOperator, patr, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public type type() throws ParseException {
    ...
    if (jj_2_37(2147483647)) {
      ...
      case INFIX_QUOTE:
        var = var();
         {if (true) return new type2(var, firstToken.next,token);}
        break;
      case LEFT_PAREN:
        jj_consume_token(LEFT_PAREN);
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      case LEFT_BRACKET:
        ...
        functiontype = functiontype();
        jj_consume_token(RIGHT_BRACKET);
         {if (true) return new type4(functiontype, firstToken.next,token);}
        break;
      default:
        jj_la1[88] = jj_gen;
        jj_consume_token(-1);
  ...
  final public functiontype functiontype() throws ParseException {
        type type;
        typArr typArr;
        ArrayList<typArr> typArrList = new ArrayList<typArr>();
        Token firstToken=token;
    type = type();
    label_33:
    while (true) {
      ...
      typArr = typArr();
                                                  typArrList.add(typArr);
    }
         {if (true) return new functiontype(type, typArrList, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }

  final public typArr typArr() throws ParseException {
        ASTTextNode text7 = null;
        type type;
        Token firstToken=token;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OTHER7:
      jj_consume_token(OTHER7);
               text7=new ASTTextNode("->",new WToken(token));
      break;
    default:
      jj_la1[91] = jj_gen;
      ;
    ...
    type = type();
         {if (true) return new typArr(text7, type, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public context context() throws ParseException {
        klasse klasse;
        klasse klasse1;
        ArrayList<klasse> list1=new ArrayList<klasse>();
        klasse klasse2;
    ...
    case LEFT_PAREN:
      ...
      jj_consume_token(RIGHT_PAREN);
      jj_consume_token(CONTEXT_ARROW);
         {if (true) return new context2(list1, firstToken.next,token);}
      break;
    default:
      jj_la1[93] = jj_gen;
      jj_consume_token(-1);
  ...
  final public klasse klasse() throws ParseException {
    ...
    naam = naam();
    klasseTypeVar = klasseTypeVar();
         {if (true) return new klasse(naam, klasseTypeVar, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public klasseTypeVar klasseTypeVar() throws ParseException {
    ...
    case LEFT_PAREN:
      ...
      jj_consume_token(RIGHT_PAREN);
         {if (true) return new klasseTypeVar1(var, typeList, firstToken.next,token);}
      break;
    case CONSTRUCTOR_ID:
    case VARIABLE_ID:
    case INFIX_QUOTE:
      var1 = var();
         {if (true) return new klasseTypeVar2(var1, firstToken.next,token);}
      break;
    default:
      jj_la1[95] = jj_gen;
      jj_consume_token(-1);
  ...
  final public varMain varMain() throws ParseException {
    ...
    case INFIX_QUOTE:
      ...
      varOperator = varOperator();
      jj_consume_token(INFIX_QUOTE);
         {if (true) return new varMain2(varOperator, firstToken.next,token);}
      break;
    default:
      jj_la1[97] = jj_gen;
      jj_consume_token(-1);
  ...
  final public naam naam() throws ParseException {
    ...
    naamMain = naamMain();
         {if (true) return new naam(moduleNaamPrefix, naamMain, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }

  final public naamMain naamMain() throws ParseException {
        Token t;
    ...
    case CONSTRUCTOR_ID:
      t = jj_consume_token(CONSTRUCTOR_ID);
         ...
         {if (true) return new naamMain1(constructor_id, firstToken.next,token);}
      break;
    case INFIX_QUOTE:
      jj_consume_token(INFIX_QUOTE);
      constructorOperator = constructorOperator();
      jj_consume_token(INFIX_QUOTE);
         {if (true) return new naamMain2(constructorOperator, firstToken.next,token);}
      break;
    default:
      jj_la1[99] = jj_gen;
      jj_consume_token(-1);
  ...
  final public operator operator() throws ParseException {
    ...
    if (jj_2_40(2147483647)) {
      varOperator = varOperator();
         {if (true) return new operator1(varOperator, firstToken.next,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OTHER1:
      case OTHER2:
      ...
      case CONSYM:
        constructorOperator = constructorOperator();
         {if (true) return new operator2(constructorOperator, firstToken.next,token);}
        break;
      default:
        jj_la1[101] = jj_gen;
        jj_consume_token(-1);
  ...
  final public varOperator varOperator() throws ParseException {
        ModuleNaamPrefix moduleNaamPrefix = null;
        varOperatorMain varOperatorMain;
        Token firstToken=token;
    ...
    varOperatorMain = varOperatorMain();
         {if (true) return new varOperator(moduleNaamPrefix, varOperatorMain, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }

  final public varOperatorMain varOperatorMain() throws ParseException {
        Token t;
    ...
    case VARSYM:
      t = jj_consume_token(VARSYM);
         ...
         {if (true) return new varOperatorMain1(varsym, firstToken.next,token);}
      break;
    case OTHER1:
    case OTHER2:
    case OTHER4:
    case OTHER8:
      otherOperators = otherOperators();
         {if (true) return new varOperatorMain2(otherOperators, firstToken.next,token);}
      break;
    case LEFT_PAREN:
      jj_consume_token(LEFT_PAREN);
      var = var();
      jj_consume_token(RIGHT_PAREN);
         {if (true) return new varOperatorMain3(var, firstToken.next,token);}
      break;
    default:
      jj_la1[102] = jj_gen;
      jj_consume_token(-1);
  ...
  final public constructorOperator constructorOperator() throws ParseException {
        ModuleNaamPrefix moduleNaamPrefix = null;
        constructorOperatorMain constructorOperatorMain;
        Token firstToken=token;
    ...
    constructorOperatorMain = constructorOperatorMain();
         {if (true) return new constructorOperator(moduleNaamPrefix, constructorOperatorMain, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }

  final public constructorOperatorMain constructorOperatorMain() throws ParseException {
        Token t;
    ...
    case CONSYM:
      t = jj_consume_token(CONSYM);
         ...
         {if (true) return new constructorOperatorMain1(consym, firstToken.next,token);}
      break;
    case OTHER1:
    case OTHER2:
    case OTHER4:
    case OTHER8:
      otherOperators = otherOperators();
         {if (true) return new constructorOperatorMain2(otherOperators, firstToken.next,token);}
      break;
    case OTHER6:
      jj_consume_token(OTHER6);
         {if (true) return new constructorOperatorMain3(firstToken.next,token);}
      break;
    case LEFT_PAREN:
      jj_consume_token(LEFT_PAREN);
      naam = naam();
      jj_consume_token(RIGHT_PAREN);
         {if (true) return new constructorOperatorMain4(naam, firstToken.next,token);}
      break;
    default:
      jj_la1[103] = jj_gen;
      jj_consume_token(-1);
  ...
  final public ModuleNaamPrefix ModuleNaamPrefix() throws ParseException {
        naamMain naamMain;
        naamMain naamMain1;
        ArrayList<naamMain> naamMain1List = new ArrayList<naamMain>();
        Token firstToken=token;
    naamMain = naamMain();
    ...
    while (true) {
      ...
      naamMain1 = naamMain();
                                                                                naamMain1List.add(naamMain1);
      jj_consume_token(OTHER1);
    }
         {if (true) return new ModuleNaamPrefix(naamMain, naamMain1List, firstToken.next,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x2,0x0,0x41c03f00,0x8,0x0,0x2,0x10,0x40,0x80,0x80,0x2,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x20,0x20,0x4,0x4,0x41c03f00,0x0,0x8000000,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x41c00000,0x0,0x4,0x8000000,0x4,0x4,0x8000000,0x4,0x0,0x0,0x0,0x1c00000,0x40000000,0x40000000,0x40000000,0x0,0x0,0x400b4000,0x400b4000,0x0,0x0,0x0,0x0,0x10000000,0x0,0x40000000,0x0,0x400b4000,0x0,0x0,0x400b4000,0x0,0x400b4000,0x0,0x0,0x4000,0x4,0x8000000,0x4,0x40000000,0x40000000,0x40000000,0x0,0x40000000,0x0,0x40000000,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x60000000,0x60000000,0x60000000,0x60000000,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0xc78003,0x0,0x0,0x18000,0x0,0x0,0x0,0x0,0x18000,0x0,0x0,0x8000,0x18000,0x0,0x0,0x18000,0x0,0x0,0x0,0x0,0x0,0xc78003,0x18000,0x0,0x0,0x18000,0x18000,0x8000,0x0,0x18000,0x0,0x8000,0x8000,0x0,0xc78003,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000,0x20000,0x20000,0x18000,0xc78003,0xc78003,0xc78003,0x0,0x0,0xc78020,0xc78020,0xc60000,0x8000,0x0,0x0,0x0,0xc78000,0xc78003,0x0,0xc78020,0x0,0x0,0xc78020,0x0,0xc78020,0x0,0x0,0x0,0x0,0x0,0x0,0xc78003,0xc78003,0xc78003,0x18002,0x0,0x0,0xc78003,0xc78003,0xc60001,0x8000,0x0,0x0,0x18000,0x18000,0x0,0x18008,0x8,0x0,0x8000,0x18000,0x18000,0x0,0x10000,0x0,0x8000,0x0,0x8015,0x11,0x15,0x11,0xc60000,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x10,0x4a0,0x0,0x20,0x400,0x0,0x0,0x20,0x0,0x400,0x200,0x20,0x400,0x400,0x20,0x200,0x400,0x10,0x0,0x0,0x0,0x0,0x4a0,0x400,0x0,0x10,0x4a0,0x4a0,0x400,0x0,0x4a4,0x200,0x400,0x400,0xa0,0x4a0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x4a0,0x4a0,0x4a0,0x4,0x4,0x4a0,0x4a0,0x0,0x400,0xa0,0x200,0x0,0x4a0,0x4a0,0x10,0x4a0,0x200,0x200,0x4a0,0x200,0x4a0,0x10,0x200,0x0,0x0,0x0,0x0,0x4a0,0x4a0,0x4a0,0x400,0x0,0x4,0x4a0,0x4a0,0x0,0x4a0,0x200,0x200,0x4a0,0x4a0,0x200,0x4a0,0x0,0x200,0x420,0x4a0,0x420,0x200,0x400,0x200,0x400,0x200,0x1420,0x820,0x1020,0x0,0x0,};
   }
