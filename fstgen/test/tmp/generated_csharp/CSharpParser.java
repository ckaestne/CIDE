...
public class CSharpParser extends AbstractFSTParser implements CSharpParserConstants {
    ...
    case IDENTIFIER:
      t = jj_consume_token(IDENTIFIER);
                        replaceName(new FSTInfo("<IDENTIFIER>",t.toString()));
                                                                                 {if (true) return productionEndTerminal("identifier1","-","{<IDENTIFIER>}","error",first,token);}
      break;
    case MODULE:
      jj_consume_token(MODULE);
                   {if (true) return productionEndTerminal("identifier2","-","module","error",first,token);}
      break;
    case ASSEMBLY:
      jj_consume_token(ASSEMBLY);
                     {if (true) return productionEndTerminal("identifier3","-","assembly","error",first,token);}
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo literal(boolean inTerminal) throws ParseException {
    ...
    case NULL:
      jj_consume_token(NULL);
                 {if (true) return productionEndTerminal("literal7","-","-","error",first,token);}
      break;
    default:
      jj_la1[4] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo boolean_literal(boolean inTerminal) throws ParseException {
    ...
    case TRUE:
      jj_consume_token(TRUE);
                 {if (true) return productionEndTerminal("boolean_literal1","-","-","error",first,token);}
      break;
    case FALSE:
      jj_consume_token(FALSE);
                  {if (true) return productionEndTerminal("boolean_literal2","-","-","error",first,token);}
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
      ...
      n = type_name_part(true);
                                                                                                                  replaceName("type_name_part", n);
                                                                                                                                                      replaceName(n);
                                                                                                                                                                          ...
                                                                                                                                                                          {if (true) return productionEndTerminal("type_name","-","{type_name_part}^.","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_name_part(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                             ...
                                                                                                                             {if (true) return productionEndTerminal("type_name_part","-","{identifier}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_argument_list(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(GTHAN);
                                                                                      {if (true) return productionEndTerminal("type_argument_list","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                     ...
                                                                                                     {if (true) return productionEndTerminal("type","-","{TOSTRING}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      default:
        ...
        break label_4;
                                                     ...
                                                     {if (true) return productionEndTerminal("rank_specifiers","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo rank_specifier(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACK);
                         {if (true) return productionEndTerminal("rank_specifier","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo non_array_type(boolean inTerminal) throws ParseException {
    ...
    case VOID:
      n = predefined_type(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("non_array_type1","-","-","error",first,token);}
      break;
    case ASSEMBLY:
    case MODULE:
    case IDENTIFIER:
      n = type_name(true);
                           replaceName(n);
                                             {if (true) return productionEndTerminal("non_array_type2","-","-","error",first,token);}
      break;
    default:
      jj_la1[13] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo predefined_type(boolean inTerminal) throws ParseException {
    ...
    case USHORT:
      n = simple_type(true);
                             replaceName(n);
                                               {if (true) return productionEndTerminal("predefined_type1","-","-","error",first,token);}
      break;
    case OBJECT:
      jj_consume_token(OBJECT);
                   {if (true) return productionEndTerminal("predefined_type2","-","-","error",first,token);}
      break;
    case STRING:
      jj_consume_token(STRING);
                   {if (true) return productionEndTerminal("predefined_type3","-","-","error",first,token);}
      break;
    case VOID:
      jj_consume_token(VOID);
                 {if (true) return productionEndTerminal("predefined_type4","-","-","error",first,token);}
      break;
    default:
      jj_la1[14] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo simple_type(boolean inTerminal) throws ParseException {
    ...
    case USHORT:
      n = numeric_type(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("simple_type1","-","-","error",first,token);}
      break;
    case BOOL:
      jj_consume_token(BOOL);
                 {if (true) return productionEndTerminal("simple_type2","-","-","error",first,token);}
      break;
    default:
      jj_la1[15] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo numeric_type(boolean inTerminal) throws ParseException {
    ...
    case USHORT:
      n = integral_type(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("numeric_type1","-","-","error",first,token);}
      break;
    case DOUBLE:
    case FLOAT:
      n = floating_point_type(true);
                                     replaceName(n);
                                                       {if (true) return productionEndTerminal("numeric_type2","-","-","error",first,token);}
      break;
    case DECIMAL:
      jj_consume_token(DECIMAL);
                    {if (true) return productionEndTerminal("numeric_type3","-","-","error",first,token);}
      break;
    default:
      jj_la1[16] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo integral_type(boolean inTerminal) throws ParseException {
    ...
    case SBYTE:
      jj_consume_token(SBYTE);
                  {if (true) return productionEndTerminal("integral_type1","-","-","error",first,token);}
      break;
    case BYTE:
      jj_consume_token(BYTE);
                 {if (true) return productionEndTerminal("integral_type2","-","-","error",first,token);}
      break;
    case SHORT:
      jj_consume_token(SHORT);
                  {if (true) return productionEndTerminal("integral_type3","-","-","error",first,token);}
      break;
    case USHORT:
      jj_consume_token(USHORT);
                   {if (true) return productionEndTerminal("integral_type4","-","-","error",first,token);}
      break;
    case INT:
      jj_consume_token(INT);
                {if (true) return productionEndTerminal("integral_type5","-","-","error",first,token);}
      break;
    case UINT:
      jj_consume_token(UINT);
                 {if (true) return productionEndTerminal("integral_type6","-","-","error",first,token);}
      break;
    case LONG:
      jj_consume_token(LONG);
                 {if (true) return productionEndTerminal("integral_type7","-","-","error",first,token);}
      break;
    case ULONG:
      jj_consume_token(ULONG);
                  {if (true) return productionEndTerminal("integral_type8","-","-","error",first,token);}
      break;
    case CHAR:
      jj_consume_token(CHAR);
                 {if (true) return productionEndTerminal("integral_type9","-","-","error",first,token);}
      break;
    default:
      jj_la1[17] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo class_type(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = type_name(true);
                           replaceName(n);
                                             {if (true) return productionEndTerminal("class_type1","-","-","error",first,token);}
      break;
    case OBJECT:
      jj_consume_token(OBJECT);
                   {if (true) return productionEndTerminal("class_type2","-","-","error",first,token);}
      break;
    case STRING:
      jj_consume_token(STRING);
                   {if (true) return productionEndTerminal("class_type3","-","-","error",first,token);}
      break;
    default:
      jj_la1[18] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo floating_point_type(boolean inTerminal) throws ParseException {
    ...
    case FLOAT:
      jj_consume_token(FLOAT);
                  {if (true) return productionEndTerminal("floating_point_type1","-","-","error",first,token);}
      break;
    case DOUBLE:
      jj_consume_token(DOUBLE);
                   {if (true) return productionEndTerminal("floating_point_type2","-","-","error",first,token);}
      break;
    default:
      jj_la1[19] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                          replaceName(n);
                                                                                            {if (true) return productionEndTerminal("expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo assignment(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                                                                           replaceName(n);
                                                                                                                                             {if (true) return productionEndTerminal("assignment","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo assignment_operator(boolean inTerminal) throws ParseException {
    ...
    case ASSIGN:
      jj_consume_token(ASSIGN);
              {if (true) return productionEndTerminal("assignment_operator1","-","-","error",first,token);}
      break;
    case PLUS_ASN:
      jj_consume_token(PLUS_ASN);
               {if (true) return productionEndTerminal("assignment_operator2","-","-","error",first,token);}
      break;
    case MINUS_ASN:
      jj_consume_token(MINUS_ASN);
               {if (true) return productionEndTerminal("assignment_operator3","-","-","error",first,token);}
      break;
    case STAR_ASN:
      jj_consume_token(STAR_ASN);
               {if (true) return productionEndTerminal("assignment_operator4","-","-","error",first,token);}
      break;
    case DIV_ASN:
      jj_consume_token(DIV_ASN);
               {if (true) return productionEndTerminal("assignment_operator5","-","-","error",first,token);}
      break;
    case MOD_ASN:
      jj_consume_token(MOD_ASN);
               {if (true) return productionEndTerminal("assignment_operator6","-","-","error",first,token);}
      break;
    case BAND_ASN:
      jj_consume_token(BAND_ASN);
               {if (true) return productionEndTerminal("assignment_operator7","-","-","error",first,token);}
      break;
    case BOR_ASN:
      jj_consume_token(BOR_ASN);
               {if (true) return productionEndTerminal("assignment_operator8","-","-","error",first,token);}
      break;
    case BXOR_ASN:
      jj_consume_token(BXOR_ASN);
               {if (true) return productionEndTerminal("assignment_operator9","-","-","error",first,token);}
      break;
    case SL_ASN:
      jj_consume_token(SL_ASN);
                {if (true) return productionEndTerminal("assignment_operator10","-","-","error",first,token);}
      break;
    case SR_ASN:
      jj_consume_token(SR_ASN);
                {if (true) return productionEndTerminal("assignment_operator11","-","-","error",first,token);}
      break;
    case BSR_ASN:
      jj_consume_token(BSR_ASN);
                 {if (true) return productionEndTerminal("assignment_operator12","-","-","error",first,token);}
      break;
    default:
      jj_la1[21] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo conditional_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                        ...
                                                                                                                        {if (true) return productionEndTerminal("conditional_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo conditional_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = conditional_expression(true);
                                                                                     replaceName(n);
                                                                                                       {if (true) return productionEndTerminal("conditional_expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo conditional_or_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                         ...
                                                                                                                         {if (true) return productionEndTerminal("conditional_or_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo conditional_and_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                       ...
                                                                                                                       {if (true) return productionEndTerminal("conditional_and_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo inclusive_or_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                   ...
                                                                                                                   {if (true) return productionEndTerminal("inclusive_or_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo exclusive_or_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                          ...
                                                                                                          {if (true) return productionEndTerminal("exclusive_or_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo and_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                      ...
                                                                                                      {if (true) return productionEndTerminal("and_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo equality_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                 ...
                                                                                                                 {if (true) return productionEndTerminal("equality_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo equality_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = equality_expression(true);
                                                                                 replaceName(n);
                                                                                                   {if (true) return productionEndTerminal("equality_expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo equality_operator(boolean inTerminal) throws ParseException {
    ...
    case EQUAL:
      jj_consume_token(EQUAL);
               {if (true) return productionEndTerminal("equality_operator1","-","-","error",first,token);}
      break;
    case NOT_EQUAL:
      jj_consume_token(NOT_EQUAL);
               {if (true) return productionEndTerminal("equality_operator2","-","-","error",first,token);}
      break;
    default:
      jj_la1[29] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo relational_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                              ...
                                                                                                              {if (true) return productionEndTerminal("relational_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo relational_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    case GE:
      ...
      n = relational_expression(true);
                                                                                     replaceName(n);
                                                                                                       {if (true) return productionEndTerminal("relational_expressionInternal1","-","-","error",first,token);}
      break;
    case AS:
    case IS:
      ...
      n = type(true);
                                                                      replaceName(n);
                                                                                        {if (true) return productionEndTerminal("relational_expressionInternal2","-","-","error",first,token);}
      break;
    default:
      jj_la1[31] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo relational_operator(boolean inTerminal) throws ParseException {
    ...
    case LTHAN:
      jj_consume_token(LTHAN);
              {if (true) return productionEndTerminal("relational_operator1","-","-","error",first,token);}
      break;
    case GTHAN:
      jj_consume_token(GTHAN);
              {if (true) return productionEndTerminal("relational_operator2","-","-","error",first,token);}
      break;
    case LE:
      jj_consume_token(LE);
               {if (true) return productionEndTerminal("relational_operator3","-","-","error",first,token);}
      break;
    case GE:
      jj_consume_token(GE);
               {if (true) return productionEndTerminal("relational_operator4","-","-","error",first,token);}
      break;
    default:
      jj_la1[32] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo relational_operator2I(boolean inTerminal) throws ParseException {
    ...
    case IS:
      jj_consume_token(IS);
               {if (true) return productionEndTerminal("relational_operator2I1","-","-","error",first,token);}
      break;
    case AS:
      jj_consume_token(AS);
               {if (true) return productionEndTerminal("relational_operator2I2","-","-","error",first,token);}
      break;
    default:
      jj_la1[33] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo shift_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                            ...
                                                                                                            {if (true) return productionEndTerminal("shift_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo shift_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = shift_expression(true);
                                                                           replaceName(n);
                                                                                             {if (true) return productionEndTerminal("shift_expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo shift_operator(boolean inTerminal) throws ParseException {
    ...
    case SL:
      jj_consume_token(SL);
               {if (true) return productionEndTerminal("shift_operator1","-","-","error",first,token);}
      break;
    case SR:
      jj_consume_token(SR);
               {if (true) return productionEndTerminal("shift_operator2","-","-","error",first,token);}
      break;
    default:
      jj_la1[35] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo additive_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                     ...
                                                                                                                     {if (true) return productionEndTerminal("additive_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo additive_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = additive_expression(true);
                                                                                 replaceName(n);
                                                                                                   {if (true) return productionEndTerminal("additive_expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo additive_operator(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("additive_operator1","-","-","error",first,token);}
      break;
    case MINUS:
      jj_consume_token(MINUS);
              {if (true) return productionEndTerminal("additive_operator2","-","-","error",first,token);}
      break;
    default:
      jj_la1[37] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo multiplicative_expression(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                  ...
                                                                                                                  {if (true) return productionEndTerminal("multiplicative_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo multiplicative_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    n = multiplicative_expression(true);
                                                                                             replaceName(n);
                                                                                                               {if (true) return productionEndTerminal("multiplicative_expressionInternal","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo multiplicative_operator(boolean inTerminal) throws ParseException {
    ...
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("multiplicative_operator1","-","-","error",first,token);}
      break;
    case DIV:
      jj_consume_token(DIV);
              {if (true) return productionEndTerminal("multiplicative_operator2","-","-","error",first,token);}
      break;
    case MOD:
      jj_consume_token(MOD);
              {if (true) return productionEndTerminal("multiplicative_operator3","-","-","error",first,token);}
      break;
    default:
      jj_la1[39] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo unary_expression(boolean inTerminal) throws ParseException {
    ...
    case BANG:
      ...
      n = unary_expression(true);
                                                                           replaceName(n);
                                                                                             {if (true) return productionEndTerminal("unary_expression1","-","-","error",first,token);}
      break;
    default:
      jj_la1[40] = jj_gen;
      if (jj_2_1(2147483647)) {
        n = cast_expression(true);
                                                              replaceName(n);
                                                                                {if (true) return productionEndTerminal("unary_expression2","-","-","error",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LONG:
        case BASE:
        ...
        case VERBATIM_STRING_LITERAL:
          n = primary_expression(true);
                                    replaceName(n);
                                                      {if (true) return productionEndTerminal("unary_expression3","-","-","error",first,token);}
          break;
        default:
          jj_la1[41] = jj_gen;
          jj_consume_token(-1);
  ...
  final public FSTInfo unary_operator(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("unary_operator1","-","-","error",first,token);}
      break;
    case MINUS:
      jj_consume_token(MINUS);
              {if (true) return productionEndTerminal("unary_operator2","-","-","error",first,token);}
      break;
    case BANG:
      jj_consume_token(BANG);
              {if (true) return productionEndTerminal("unary_operator3","-","-","error",first,token);}
      break;
    case TILDE:
      jj_consume_token(TILDE);
              {if (true) return productionEndTerminal("unary_operator4","-","-","error",first,token);}
      break;
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("unary_operator5","-","-","error",first,token);}
      break;
    case INC:
      jj_consume_token(INC);
               {if (true) return productionEndTerminal("unary_operator6","-","-","error",first,token);}
      break;
    case DEC:
      jj_consume_token(DEC);
               {if (true) return productionEndTerminal("unary_operator7","-","-","error",first,token);}
      break;
    default:
      jj_la1[42] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo cast_expression(boolean inTerminal) throws ParseException {
    ...
    n = unary_expression(true);
                                                                         replaceName(n);
                                                                                           {if (true) return productionEndTerminal("cast_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case VERBATIM_STRING_LITERAL:
      ...
      default:
        ...
        ;
                                                                                                                   ...
                                                                                                                   {if (true) return productionEndTerminal("primary_expression1","-","-","error",first,token);}
      break;
    case NEW:
      n = creation_expression(true);
                                     replaceName(n);
                                                       {if (true) return productionEndTerminal("primary_expression2","-","-","error",first,token);}
      break;
    default:
      jj_la1[44] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo primary_expression_start(boolean inTerminal) throws ParseException {
    ...
    case VERBATIM_STRING_LITERAL:
      n = literal(true);
                         replaceName(n);
                                           {if (true) return productionEndTerminal("primary_expression_start1","-","-","error",first,token);}
      break;
    case ASSEMBLY:
    case MODULE:
    case IDENTIFIER:
      n = identifier(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("primary_expression_start2","-","-","error",first,token);}
      break;
    case LPAREN:
      n = parenthesized_expression(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("primary_expression_start3","-","-","error",first,token);}
      break;
    case LONG:
    case BOOL:
    case OBJECT:
    ...
    case VOID:
      ...
      n = member_access(true);
                                                                         replaceName(n);
                                                                                           {if (true) return productionEndTerminal("primary_expression_start4","-","-","error",first,token);}
      break;
    case THIS:
      n = this_access(true);
                             replaceName(n);
                                               {if (true) return productionEndTerminal("primary_expression_start5","-","-","error",first,token);}
      break;
    case BASE:
      n = base_access(true);
                             replaceName(n);
                                               {if (true) return productionEndTerminal("primary_expression_start6","-","-","error",first,token);}
      break;
    case TYPEOF:
      n = typeof_expression(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("primary_expression_start7","-","-","error",first,token);}
      break;
    case SIZEOF:
      n = sizeof_expression(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("primary_expression_start8","-","-","error",first,token);}
      break;
    case CHECKED:
      n = checked_expression(true);
                                    replaceName(n);
                                                      {if (true) return productionEndTerminal("primary_expression_start9","-","-","error",first,token);}
      break;
    case UNCHECKED:
      n = unchecked_expression(true);
                                      replaceName(n);
                                                        {if (true) return productionEndTerminal("primary_expression_start10","-","-","error",first,token);}
      break;
    case DEFAULTTOKEN:
      n = default_value_expression(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("primary_expression_start11","-","-","error",first,token);}
      break;
    default:
      jj_la1[45] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo default_value_expression(boolean inTerminal) throws ParseException {
    ...
    n = type(true);
                                    replaceName(n);
    jj_consume_token(RPAREN);
                                                          {if (true) return productionEndTerminal("default_value_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      default:
        ...
        break label_6;
                                                                         ...
                                                                         {if (true) return productionEndTerminal("primary_expression_postfix","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo primary_expression_postfixInternal(boolean inTerminal) throws ParseException {
    ...
    case DOT:
      n = member_access(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("primary_expression_postfixInternal1","-","-","error",first,token);}
      break;
    case LPAREN:
    case LTHAN:
      n = invocation_expression(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("primary_expression_postfixInternal2","-","-","error",first,token);}
      break;
    case LBRACK:
      n = element_access(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("primary_expression_postfixInternal3","-","-","error",first,token);}
      break;
    case INC:
      n = post_increment_expression(true);
                                           replaceName(n);
                                                             {if (true) return productionEndTerminal("primary_expression_postfixInternal4","-","-","error",first,token);}
      break;
    case DEC:
      n = post_decrement_expression(true);
                                           replaceName(n);
                                                             {if (true) return productionEndTerminal("primary_expression_postfixInternal5","-","-","error",first,token);}
      break;
    case ARROW:
      n = pointer_member_access(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("primary_expression_postfixInternal6","-","-","error",first,token);}
      break;
    default:
      jj_la1[47] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_7;
                                                                                ...
                                                                                {if (true) return productionEndTerminal("array_creation_postfix_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo array_creation_postfix_expressionInternal(boolean inTerminal) throws ParseException {
    ...
    case DOT:
      n = member_access(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("array_creation_postfix_expressionInternal1","-","-","error",first,token);}
      break;
    case LPAREN:
    case LTHAN:
      n = invocation_expression(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("array_creation_postfix_expressionInternal2","-","-","error",first,token);}
      break;
    case INC:
      n = post_increment_expression(true);
                                           replaceName(n);
                                                             {if (true) return productionEndTerminal("array_creation_postfix_expressionInternal3","-","-","error",first,token);}
      break;
    case DEC:
      n = post_decrement_expression(true);
                                           replaceName(n);
                                                             {if (true) return productionEndTerminal("array_creation_postfix_expressionInternal4","-","-","error",first,token);}
      break;
    case ARROW:
      n = pointer_member_access(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("array_creation_postfix_expressionInternal5","-","-","error",first,token);}
      break;
    default:
      jj_la1[49] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo creation_expression(boolean inTerminal) throws ParseException {
    ...
    n = creation_expressionPostFix(true);
                                                                                           replaceName(n);
                                                                                                             {if (true) return productionEndTerminal("creation_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case LPAREN:
      ...
      default:
        ...
        ;
                                                                                                                  ...
                                                                                                                  {if (true) return productionEndTerminal("creation_expressionPostFix1","-","-","error",first,token);}
      break;
    default:
      jj_la1[56] = jj_gen;
      if (jj_2_2(2)) {
        ...
        default:
          ...
          ;
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                {if (true) return productionEndTerminal("creation_expressionPostFix2","-","-","error",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LBRACK:
          n = rank_specifiers(true);
          ...
          default:
            ...
            ;
                                                                                                                                                             ...
                                                                                                                                                             {if (true) return productionEndTerminal("creation_expressionPostFix3","-","-","error",first,token);}
          break;
        default:
          jj_la1[57] = jj_gen;
          jj_consume_token(-1);
  ...
  final public FSTInfo parenthesized_expression(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                replaceName(n);
    jj_consume_token(RPAREN);
                                                      {if (true) return productionEndTerminal("parenthesized_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo member_access(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                 ...
                                                                                                 {if (true) return productionEndTerminal("member_access","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo invocation_expression(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
                                                                                                          {if (true) return productionEndTerminal("invocation_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = argument(true);
                                                                  replaceName(n);
                                                                                      ...
                                                                                      {if (true) return productionEndTerminal("argument_list","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo argument(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                       replaceName(n);
                                                                                         {if (true) return productionEndTerminal("argument","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo argumentPrefix(boolean inTerminal) throws ParseException {
    ...
    case REF:
      jj_consume_token(REF);
                {if (true) return productionEndTerminal("argumentPrefix1","-","-","error",first,token);}
      break;
    case OUT:
      jj_consume_token(OUT);
                {if (true) return productionEndTerminal("argumentPrefix2","-","-","error",first,token);}
      break;
    default:
      jj_la1[63] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo element_access(boolean inTerminal) throws ParseException {
    ...
    n = argument_list(true);
                                   replaceName(n);
    jj_consume_token(RBRACK);
                                                         {if (true) return productionEndTerminal("element_access","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = expression_listList(true);
                                                                           replaceName(n);
                                                                                               ...
                                                                                               {if (true) return productionEndTerminal("expression_list","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo expression_listList(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("expression_listList","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo this_access(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(THIS);
                 {if (true) return productionEndTerminal("this_access","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo base_access(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_3(2)) {
      ...
      n = member_access(true);
                                                   replaceName(n);
                                                                     {if (true) return productionEndTerminal("base_access1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case BASE:
        jj_consume_token(BASE);
        n = element_access(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("base_access2","-","-","error",first,token);}
        break;
      default:
        jj_la1[65] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo post_increment_expression(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(INC);
               {if (true) return productionEndTerminal("post_increment_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo post_decrement_expression(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(DEC);
               {if (true) return productionEndTerminal("post_decrement_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo typeof_expression(boolean inTerminal) throws ParseException {
    ...
    n = type(true);
                                   replaceName(n);
    jj_consume_token(RPAREN);
                                                         {if (true) return productionEndTerminal("typeof_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo checked_expression(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                          replaceName(n);
    jj_consume_token(RPAREN);
                                                                {if (true) return productionEndTerminal("checked_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo unchecked_expression(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                            replaceName(n);
    jj_consume_token(RPAREN);
                                                                  {if (true) return productionEndTerminal("unchecked_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_variable_declaration(boolean inTerminal) throws ParseException {
    ...
    n = local_variable_declarators(true);
                                                                           replaceName(n);
                                                                                             {if (true) return productionEndTerminal("local_variable_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_variable_declarators(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                        ...
                                                                                                                        {if (true) return productionEndTerminal("local_variable_declarators","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_variable_declarator(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                    ...
                                                                                                    {if (true) return productionEndTerminal("local_variable_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_variable_assignment(boolean inTerminal) throws ParseException {
    ...
    n = local_variable_initializer(true);
                                                replaceName(n);
                                                                  {if (true) return productionEndTerminal("local_variable_assignment","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_variable_initializer(boolean inTerminal) throws ParseException {
    ...
    case LBRACE:
      n = array_initializer(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("local_variable_initializer1","-","-","error",first,token);}
      break;
    case LONG:
    case BASE:
    case NEW:
    ...
    case VERBATIM_STRING_LITERAL:
      n = expression(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("local_variable_initializer2","-","-","error",first,token);}
      break;
    default:
      jj_la1[69] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo local_constant_declaration(boolean inTerminal) throws ParseException {
    ...
    n = local_constant_declarators(true);
                                                                                   replaceName(n);
                                                                                                     {if (true) return productionEndTerminal("local_constant_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_constant_declarators(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                        ...
                                                                                                                        {if (true) return productionEndTerminal("local_constant_declarators","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_constant_declarator(boolean inTerminal) throws ParseException {
    ...
    n = local_variable_initializer(true);
                                                                                     replaceName(n);
                                                                                                       {if (true) return productionEndTerminal("local_constant_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo embedded_statement(boolean inTerminal) throws ParseException {
    ...
    case LBRACE:
      n = block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("embedded_statement1","-","-","error",first,token);}
      break;
    case SEMI:
      jj_consume_token(SEMI);
              {if (true) return productionEndTerminal("embedded_statement2","-","-","error",first,token);}
      break;
    case SWITCH:
    case IF:
      n = selection_statement(true);
                                     replaceName(n);
                                                       {if (true) return productionEndTerminal("embedded_statement3","-","-","error",first,token);}
      break;
    case DO:
    case FOR:
    case FOREACH:
    case WHILE:
      n = iteration_statement(true);
                                     replaceName(n);
                                                       {if (true) return productionEndTerminal("embedded_statement4","-","-","error",first,token);}
      break;
    case BREAK:
    case CONTINUE:
    case RETURN:
    ...
    case GOTO:
      n = jump_statement(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("embedded_statement5","-","-","error",first,token);}
      break;
    case TRY:
      n = try_statement(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("embedded_statement6","-","-","error",first,token);}
      break;
    case CHECKED:
      n = checked_statement(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("embedded_statement7","-","-","error",first,token);}
      break;
    case UNCHECKED:
      n = unchecked_statement(true);
                                     replaceName(n);
                                                       {if (true) return productionEndTerminal("embedded_statement8","-","-","error",first,token);}
      break;
    case LOCK:
      n = lock_statement(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("embedded_statement9","-","-","error",first,token);}
      break;
    case USING:
      n = using_statement(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("embedded_statement10","-","-","error",first,token);}
      break;
    case UNSAFE:
      n = unsafe_statement(true);
                                  replaceName(n);
                                                    {if (true) return productionEndTerminal("embedded_statement11","-","-","error",first,token);}
      break;
    case FIXED:
      n = fixed_statement(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("embedded_statement12","-","-","error",first,token);}
      break;
    case LONG:
    case BASE:
    case NEW:
    ...
    case VERBATIM_STRING_LITERAL:
      n = expression_statement(true);
                                      replaceName(n);
                                                        {if (true) return productionEndTerminal("embedded_statement13","-","-","error",first,token);}
      break;
    default:
      jj_la1[71] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_11;
                                                ...
                                                {if (true) return productionEndTerminal("statement_list","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo expression_statement(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                            replaceName(n);
    jj_consume_token(SEMI);
                                                  {if (true) return productionEndTerminal("expression_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo selection_statement(boolean inTerminal) throws ParseException {
    ...
    case IF:
      n = if_statement(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("selection_statement1","-","-","error",first,token);}
      break;
    case SWITCH:
      n = switch_statement(true);
                                  replaceName(n);
                                                    {if (true) return productionEndTerminal("selection_statement2","-","-","error",first,token);}
      break;
    default:
      jj_la1[74] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo if_statement(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                                                              ...
                                                                                                                                                              {if (true) return productionEndTerminal("if_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo switch_statement(boolean inTerminal) throws ParseException {
    ...
    n = switch_block(true);
                                                                                    replaceName(n);
                                                                                                      {if (true) return productionEndTerminal("switch_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo switch_block(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                                                             {if (true) return productionEndTerminal("switch_block","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo switch_section(boolean inTerminal) throws ParseException {
    ...
    n = statement_list(true);
                                                                          replaceName(n);
                                                                                            {if (true) return productionEndTerminal("switch_section","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo switch_label(boolean inTerminal) throws ParseException {
    ...
    case CASE:
      ...
      n = expression(true);
                                   replaceName(n);
      jj_consume_token(COLON);
                                                         {if (true) return productionEndTerminal("switch_label1","-","-","error",first,token);}
      break;
    case DEFAULTTOKEN:
      jj_consume_token(DEFAULTTOKEN);
      jj_consume_token(COLON);
                        {if (true) return productionEndTerminal("switch_label2","-","-","error",first,token);}
      break;
    default:
      jj_la1[78] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo iteration_statement(boolean inTerminal) throws ParseException {
    ...
    case WHILE:
      n = while_statement(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("iteration_statement1","-","-","error",first,token);}
      break;
    case DO:
      n = do_statement(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("iteration_statement2","-","-","error",first,token);}
      break;
    case FOR:
      n = for_statement(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("iteration_statement3","-","-","error",first,token);}
      break;
    case FOREACH:
      n = foreach_statement(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("iteration_statement4","-","-","error",first,token);}
      break;
    default:
      jj_la1[79] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo while_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                         replaceName(n);
                                                                                                           {if (true) return productionEndTerminal("while_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo do_statement(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                                          replaceName(n);
    jj_consume_token(RPAREN);
                                                                                                                {if (true) return productionEndTerminal("do_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo for_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                                                                                                                         replaceName(n);
                                                                                                                                                                                                           {if (true) return productionEndTerminal("for_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo for_initializer(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_6(2147483647)) {
      n = local_variable_declaration(true);
                                                                           replaceName(n);
                                                                                             {if (true) return productionEndTerminal("for_initializer1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LONG:
      case BASE:
      ...
      case VERBATIM_STRING_LITERAL:
        n = expression_list(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("for_initializer2","-","-","error",first,token);}
        break;
      default:
        jj_la1[83] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo foreach_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                                                                                                    replaceName(n);
                                                                                                                                                                                      {if (true) return productionEndTerminal("foreach_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo jump_statement(boolean inTerminal) throws ParseException {
    ...
    case BREAK:
      ...
      jj_consume_token(SEMI);
                      {if (true) return productionEndTerminal("jump_statement1","-","-","error",first,token);}
      break;
    case CONTINUE:
      jj_consume_token(CONTINUE);
      jj_consume_token(SEMI);
                         {if (true) return productionEndTerminal("jump_statement2","-","-","error",first,token);}
      break;
    case GOTO:
      n = goto_statement(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("jump_statement3","-","-","error",first,token);}
      break;
    case RETURN:
      n = return_statement(true);
                                  replaceName(n);
                                                    {if (true) return productionEndTerminal("jump_statement4","-","-","error",first,token);}
      break;
    case THROW:
      n = throw_statement(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("jump_statement5","-","-","error",first,token);}
      break;
    default:
      jj_la1[84] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo goto_statement(boolean inTerminal) throws ParseException {
    ...
    n = goto_statementEnd(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("goto_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo goto_statementEnd(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = identifier(true);
                            replaceName(n);
      jj_consume_token(SEMI);
                                                  {if (true) return productionEndTerminal("goto_statementEnd1","-","-","error",first,token);}
      break;
    case CASE:
      jj_consume_token(CASE);
      n = expression(true);
                                   replaceName(n);
      jj_consume_token(SEMI);
                                                         {if (true) return productionEndTerminal("goto_statementEnd2","-","-","error",first,token);}
      break;
    case DEFAULTTOKEN:
      jj_consume_token(DEFAULTTOKEN);
      jj_consume_token(SEMI);
                        {if (true) return productionEndTerminal("goto_statementEnd3","-","-","error",first,token);}
      break;
    default:
      jj_la1[85] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo return_statement(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMI);
                                                             {if (true) return productionEndTerminal("return_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo throw_statement(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMI);
                                                            {if (true) return productionEndTerminal("throw_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo try_statement(boolean inTerminal) throws ParseException {
    ...
    n = try_statement_clauses(true);
                                                                             replaceName(n);
                                                                                               {if (true) return productionEndTerminal("try_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case CATCH:
      ...
      default:
        ...
        ;
                                                                                            ...
                                                                                            {if (true) return productionEndTerminal("try_statement_clauses1","-","-","error",first,token);}
      break;
    case FINALLY:
      n = finally_clause(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("try_statement_clauses2","-","-","error",first,token);}
      break;
    default:
      jj_la1[89] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_14;
                                                   ...
                                                   {if (true) return productionEndTerminal("catch_clauses","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo catch_clause(boolean inTerminal) throws ParseException {
    ...
    n = catch_clauseEnd(true);
                                         replaceName(n);
                                                           {if (true) return productionEndTerminal("catch_clause","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo catch_clauseEnd(boolean inTerminal) throws ParseException {
    ...
    case LPAREN:
      ...
      n = block(true);
                                                                                                     replaceName(n);
                                                                                                                       {if (true) return productionEndTerminal("catch_clauseEnd1","-","-","error",first,token);}
      break;
    case LBRACE:
      n = block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("catch_clauseEnd2","-","-","error",first,token);}
      break;
    default:
      jj_la1[92] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo finally_clause(boolean inTerminal) throws ParseException {
    ...
    n = block(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("finally_clause","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo checked_statement(boolean inTerminal) throws ParseException {
    ...
    n = block(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("checked_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo unchecked_statement(boolean inTerminal) throws ParseException {
    ...
    n = block(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("unchecked_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo lock_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                        replaceName(n);
                                                                                                          {if (true) return productionEndTerminal("lock_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo using_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                                   replaceName(n);
                                                                                                                     {if (true) return productionEndTerminal("using_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo resource_acquisition(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_7(2147483647)) {
      n = local_variable_declaration(true);
                                                                                         replaceName(n);
                                                                                                           {if (true) return productionEndTerminal("resource_acquisition1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LONG:
      case BASE:
      ...
      case VERBATIM_STRING_LITERAL:
        n = expression(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("resource_acquisition2","-","-","error",first,token);}
        break;
      default:
        jj_la1[93] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo using_directive(boolean inTerminal) throws ParseException {
    ...
    n = using_directiveEnd(true);
                                                                                                               replaceName(n);
                                                                                                                                 {if (true) return productionEndTerminal("using_directive","{type_name}","{type_name}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo using_directiveEnd(boolean inTerminal) throws ParseException {
    ...
    case ASSIGN:
      ...
      n = type_name(true);
                               replaceName(n);
      jj_consume_token(SEMI);
                                                     {if (true) return productionEndTerminal("using_directiveEnd1","-","-","error",first,token);}
      break;
    case SEMI:
      jj_consume_token(SEMI);
              {if (true) return productionEndTerminal("using_directiveEnd2","-","-","error",first,token);}
      break;
    default:
      jj_la1[98] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_18;
                                                    ...
                                                    {if (true) return productionEndTerminal("type_modifiers","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_modifier(boolean inTerminal) throws ParseException {
    ...
    case NEW:
      jj_consume_token(NEW);
                {if (true) return productionEndTerminal("type_modifier1","-","-","error",first,token);}
      break;
    case PUBLIC:
      jj_consume_token(PUBLIC);
                   {if (true) return productionEndTerminal("type_modifier2","-","-","error",first,token);}
      break;
    case PROTECTED:
      jj_consume_token(PROTECTED);
                      {if (true) return productionEndTerminal("type_modifier3","-","-","error",first,token);}
      break;
    case INTERNAL:
      jj_consume_token(INTERNAL);
                     {if (true) return productionEndTerminal("type_modifier4","-","-","error",first,token);}
      break;
    case PRIVATE:
      jj_consume_token(PRIVATE);
                    {if (true) return productionEndTerminal("type_modifier5","-","-","error",first,token);}
      break;
    case ABSTRACT:
      jj_consume_token(ABSTRACT);
                     {if (true) return productionEndTerminal("type_modifier6","-","-","error",first,token);}
      break;
    case SEALED:
      jj_consume_token(SEALED);
                   {if (true) return productionEndTerminal("type_modifier7","-","-","error",first,token);}
      break;
    case UNSAFE:
      jj_consume_token(UNSAFE);
                   {if (true) return productionEndTerminal("type_modifier8","-","-","error",first,token);}
      break;
    default:
      jj_la1[106] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo type_parameter_list(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(GTHAN);
                                                                                                          {if (true) return productionEndTerminal("type_parameter_list","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_parameter(boolean inTerminal) throws ParseException {
    ...
    n = identifier(true);
                                                                   replaceName(n);
                                                                                     {if (true) return productionEndTerminal("type_parameter","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = type_parameter_constraint_clause(true);
                                                                                                              replaceName(n);
                                                                                                                                  ...
                                                                                                                                  {if (true) return productionEndTerminal("type_parameter_constraint_clauses","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_parameter_constraint_clause(boolean inTerminal) throws ParseException {
    ...
    n = type_parameter_constraints(true);
                                                                                                 replaceName(n);
                                                                                                                   {if (true) return productionEndTerminal("type_parameter_constraint_clause","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case IDENTIFIER:
      ...
      default:
        ...
        ;
                                                                                                            ...
                                                                                                            {if (true) return productionEndTerminal("type_parameter_constraints1","-","-","error",first,token);}
      break;
    case LBRACK:
      ...
      default:
        ...
        ;
                                                                                                               ...
                                                                                                               {if (true) return productionEndTerminal("type_parameter_constraints2","-","-","error",first,token);}
      break;
    case NEW:
      n = constructor_constraint(true);
                                        replaceName(n);
                                                          {if (true) return productionEndTerminal("type_parameter_constraints3","-","-","error",first,token);}
      break;
    default:
      jj_la1[116] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo remaining_constraints(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                               ...
                                                                                                               {if (true) return productionEndTerminal("remaining_constraints","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo primary_constraint(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = class_type(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("primary_constraint1","-","-","error",first,token);}
      break;
    case CLASS:
      jj_consume_token(CLASS);
                  {if (true) return productionEndTerminal("primary_constraint2","-","-","error",first,token);}
      break;
    case STRUCT:
      jj_consume_token(STRUCT);
                   {if (true) return productionEndTerminal("primary_constraint3","-","-","error",first,token);}
      break;
    default:
      jj_la1[118] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      n = type_name_or_paramenter(true);
                                                                                                replaceName(n);
                                                                                                                    ...
                                                                                                                    {if (true) return productionEndTerminal("secondary_constraint","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo type_name_or_paramenter(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = type_name(true);
                           replaceName(n);
                                             {if (true) return productionEndTerminal("type_name_or_paramenter1","-","-","error",first,token);}
      break;
    case LBRACK:
      n = type_parameter(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("type_name_or_paramenter2","-","-","error",first,token);}
      break;
    default:
      jj_la1[120] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo constructor_constraint(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(LPAREN);
    jj_consume_token(RPAREN);
                        {if (true) return productionEndTerminal("constructor_constraint","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
      ...
      n = type_name(true);
                                                                                                         replaceName("type_name", n);
                                                                                                                                        replaceName(n);
                                                                                                                                                            ...
                                                                                                                                                            {if (true) return productionEndTerminal("class_base","{class_type}{type_name}^,","{class_type}{type_name}^,","error",first,token);}
    throw new Error("Missing return statement in function");
  }
      ...
      n = type_name(true);
                                                                                                   replaceName("type_name", n);
                                                                                                                                  replaceName(n);
                                                                                                                                                      ...
                                                                                                                                                      {if (true) return productionEndTerminal("interface_type_list","{type_name}^,","{type_name}^,","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    case LPAREN:
      n = constructor_declaration(true);
                                         replaceName("constructor_declaration", n);
                                                                                      replaceName(n);
                                                                                                        {if (true) return productionEndTerminal("typeEnd1","{constructor_declaration}","{constructor_declaration}","error",first,token);}
      break;
    case THIS:
      n = indexer_declaration_no_interface(true);
                                                  replaceName("indexer_declaration_no_interface", n);
                                                                                                        replaceName(n);
                                                                                                                          {if (true) return productionEndTerminal("typeEnd2","{indexer_declaration_no_interface}","{indexer_declaration_no_interface}","error",first,token);}
      break;
    case OPERATOR:
      n = operator_declaration(true);
                                      replaceName("operator_declaration", n);
                                                                                replaceName(n);
                                                                                                  {if (true) return productionEndTerminal("typeEnd3","{operator_declaration}","{operator_declaration}","error",first,token);}
      break;
    default:
      jj_la1[127] = jj_gen;
      if (jj_2_8(2147483647)) {
        n = indexer_declaration_interface(true);
                                                                             replaceName("indexer_declaration_interface", n);
                                                                                                                                replaceName(n);
                                                                                                                                                  {if (true) return productionEndTerminal("typeEnd4","{indexer_declaration_interface}","{indexer_declaration_interface}","error",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case ASSEMBLY:
        case MODULE:
        case IDENTIFIER:
          ...
          n = type_nameEnd(true);
                                                                                                 replaceName("type_nameEnd", n);
                                                                                                                                   replaceName(n);
                                                                                                                                                     {if (true) return productionEndTerminal("typeEnd5","{type_name}{type_nameEnd}","{type_name}{type_nameEnd}","c-{type_nameEnd}",first,token);}
          break;
        default:
          jj_la1[128] = jj_gen;
          jj_consume_token(-1);
    ...
    case LTHAN:
      n = method_declaration(true);
                                    replaceName("method_declaration", n);
                                                                            replaceName(n);
                                                                                              {if (true) return productionEndTerminal("type_nameEnd1","-","{method_declaration}","method",first,token);}
      break;
    case LBRACE:
      n = property_declaration(true);
                                      replaceName("property_declaration", n);
                                                                                replaceName(n);
                                                                                                  {if (true) return productionEndTerminal("type_nameEnd2","-","{property_declaration}","error",first,token);}
      break;
    case ASSIGN:
    case COMMA:
    case SEMI:
      n = field_declaration(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("type_nameEnd3","-","","field",first,token);}
      break;
    default:
      jj_la1[129] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_25;
                                                      ...
                                                      {if (true) return productionEndTerminal("member_modifiers","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo member_modifier(boolean inTerminal) throws ParseException {
    ...
    case NEW:
      jj_consume_token(NEW);
                {if (true) return productionEndTerminal("member_modifier1","-","-","error",first,token);}
      break;
    case PUBLIC:
      jj_consume_token(PUBLIC);
                   {if (true) return productionEndTerminal("member_modifier2","-","-","error",first,token);}
      break;
    case PROTECTED:
      jj_consume_token(PROTECTED);
                      {if (true) return productionEndTerminal("member_modifier3","-","-","error",first,token);}
      break;
    case INTERNAL:
      jj_consume_token(INTERNAL);
                     {if (true) return productionEndTerminal("member_modifier4","-","-","error",first,token);}
      break;
    case PRIVATE:
      jj_consume_token(PRIVATE);
                    {if (true) return productionEndTerminal("member_modifier5","-","-","error",first,token);}
      break;
    case STATIC:
      jj_consume_token(STATIC);
                   {if (true) return productionEndTerminal("member_modifier6","-","-","error",first,token);}
      break;
    case VIRTUAL:
      jj_consume_token(VIRTUAL);
                    {if (true) return productionEndTerminal("member_modifier7","-","-","error",first,token);}
      break;
    case SEALED:
      jj_consume_token(SEALED);
                   {if (true) return productionEndTerminal("member_modifier8","-","-","error",first,token);}
      break;
    case OVERRIDE:
      jj_consume_token(OVERRIDE);
                     {if (true) return productionEndTerminal("member_modifier9","-","-","error",first,token);}
      break;
    case ABSTRACT:
      jj_consume_token(ABSTRACT);
                     {if (true) return productionEndTerminal("member_modifier10","-","-","error",first,token);}
      break;
    case EXTERN:
      jj_consume_token(EXTERN);
                   {if (true) return productionEndTerminal("member_modifier11","-","-","error",first,token);}
      break;
    case READONLY:
      jj_consume_token(READONLY);
                     {if (true) return productionEndTerminal("member_modifier12","-","-","error",first,token);}
      break;
    case UNSAFE:
      jj_consume_token(UNSAFE);
                   {if (true) return productionEndTerminal("member_modifier13","-","-","error",first,token);}
      break;
    default:
      jj_la1[131] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo constant_declaration(boolean inTerminal) throws ParseException {
    ...
    n = constant_declarators(true);
                                                                             replaceName(n);
    jj_consume_token(SEMI);
                                                                                                   {if (true) return productionEndTerminal("constant_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = constant_declarator(true);
                                                                                        replaceName(n);
                                                                                                            ...
                                                                                                            {if (true) return productionEndTerminal("constant_declarators","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo constant_declarator(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                     replaceName(n);
                                                                                       {if (true) return productionEndTerminal("constant_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo field_declaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMI);
                                                                                                                 {if (true) return productionEndTerminal("field_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo field_declaration_start(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                              ...
                                                              {if (true) return productionEndTerminal("field_declaration_start","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = field_declarator(true);
                                                                                  replaceName(n);
                                                                                                      ...
                                                                                                      {if (true) return productionEndTerminal("field_declarators","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo field_declarator(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                   ...
                                                                                                   {if (true) return productionEndTerminal("field_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo variable_initializer(boolean inTerminal) throws ParseException {
    ...
    case LBRACE:
      n = array_initializer(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("variable_initializer1","-","-","error",first,token);}
      break;
    case LONG:
    case BASE:
    case NEW:
    ...
    case VERBATIM_STRING_LITERAL:
      n = expression(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("variable_initializer2","-","-","error",first,token);}
      break;
    case STACKALLOC:
      n = stackalloc_initializer(true);
                                        replaceName(n);
                                                          {if (true) return productionEndTerminal("variable_initializer3","-","-","error",first,token);}
      break;
    default:
      jj_la1[137] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo method_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                                                                                                                                                                                         replaceName(n);
                                                                                                                                                                                                                                                           {if (true) return productionEndTerminal("method_declaration","-","({formal_parameter_list})","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo body(boolean inTerminal) throws ParseException {
    ...
    case LBRACE:
      n = block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("body1","-","-","error",first,token);}
      break;
    case SEMI:
      jj_consume_token(SEMI);
              {if (true) return productionEndTerminal("body2","-","-","error",first,token);}
      break;
    default:
      jj_la1[141] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo formal_parameter_list(boolean inTerminal) throws ParseException {
    ...
    n = formal_parameter_listEnd(true);
                                                                                 replaceName("formal_parameter_listEnd", n);
                                                                                                                               replaceName(n);
                                                                                                                                                 {if (true) return productionEndTerminal("formal_parameter_list","-","{formal_parameter_listEnd}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
        ...
        n = fixed_parameterEnd(true);
                                                                                                                    replaceName("fixed_parameterEnd", n);
                                                                                                                                                            replaceName(n);
                                                                                                                                                                                ...
                                                                                                                                                                                {if (true) return productionEndTerminal("formal_parameter_listEnd1","-","{fixed_parameter} {fixed_parameterEnd}^~","error",first,token);}
      break;
    case PARAMS:
      n = parameter_array(true);
                                 replaceName("parameter_array", n);
                                                                      replaceName(n);
                                                                                        {if (true) return productionEndTerminal("formal_parameter_listEnd2","-","{parameter_array}","error",first,token);}
      break;
    default:
      jj_la1[144] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo fixed_parameterEnd(boolean inTerminal) throws ParseException {
    ...
    n = formal_parameter_listEndInt(true);
                                                                                        replaceName("formal_parameter_listEndInt", n);
                                                                                                                                         replaceName(n);
                                                                                                                                                           {if (true) return productionEndTerminal("fixed_parameterEnd","-","{formal_parameter_listEndInt}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo formal_parameter_listEndInt(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = fixed_parameter(true);
                                 replaceName("fixed_parameter", n);
                                                                      replaceName(n);
                                                                                        {if (true) return productionEndTerminal("formal_parameter_listEndInt1","-","{fixed_parameter} {fixed_parameterEnd}^~","error",first,token);}
      break;
    case PARAMS:
      n = parameter_array(true);
                                 replaceName("parameter_array", n);
                                                                      replaceName(n);
                                                                                        {if (true) return productionEndTerminal("formal_parameter_listEndInt2","-","{parameter_array}","error",first,token);}
      break;
    default:
      jj_la1[146] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo fixed_parameter(boolean inTerminal) throws ParseException {
    ...
    n = identifier(true);
                                                                                                                                    replaceName(n);
                                                                                                                                                      {if (true) return productionEndTerminal("fixed_parameter","-","{type}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo parameter_modifier(boolean inTerminal) throws ParseException {
    ...
    case REF:
      jj_consume_token(REF);
                {if (true) return productionEndTerminal("parameter_modifier1","-","{TOSTRING}","error",first,token);}
      break;
    case OUT:
      jj_consume_token(OUT);
                {if (true) return productionEndTerminal("parameter_modifier2","-","{TOSTRING}","error",first,token);}
      break;
    default:
      jj_la1[148] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo parameter_array(boolean inTerminal) throws ParseException {
    ...
    n = identifier(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("parameter_array","-","params {type}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo property_declaration(boolean inTerminal) throws ParseException {
    ...
    n = accessor_declarations(true);
                                           replaceName(n);
    jj_consume_token(RBRACE);
                                                                 {if (true) return productionEndTerminal("property_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo accessor_declarations(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                         ...
                                                                                                         {if (true) return productionEndTerminal("accessor_declarations","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo accessor_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                          replaceName(n);
                                                                                            {if (true) return productionEndTerminal("accessor_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo event_declaration(boolean inTerminal) throws ParseException {
    ...
    n = event_declarationInt(true);
                                                                             replaceName(n);
                                                                                               {if (true) return productionEndTerminal("event_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo event_declarationInt(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_9(2)) {
      ...
      n = event_accessor_declarations(true);
                                                                                                  replaceName(n);
      jj_consume_token(RBRACE);
                                                                                                                        {if (true) return productionEndTerminal("event_declarationInt1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ASSEMBLY:
      case MODULE:
      case IDENTIFIER:
        ...
        jj_consume_token(SEMI);
                                                                                                                            {if (true) return productionEndTerminal("event_declarationInt2","-","-","error",first,token);}
        break;
      default:
        jj_la1[152] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo event_variable_declarator(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                   ...
                                                                                                   {if (true) return productionEndTerminal("event_variable_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo event_accessor_declarations(boolean inTerminal) throws ParseException {
    ...
    n = accessor_declaration(true);
                                                                                     replaceName(n);
                                                                                                       {if (true) return productionEndTerminal("event_accessor_declarations","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo indexer_declaration_no_interface(boolean inTerminal) throws ParseException {
    ...
    n = accessor_declarations(true);
                                                                                                          replaceName(n);
    jj_consume_token(RBRACE);
                                                                                                                                {if (true) return productionEndTerminal("indexer_declaration_no_interface","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo indexer_declaration_interface(boolean inTerminal) throws ParseException {
    ...
    n = accessor_declarations(true);
                                                                                                                                          replaceName(n);
    jj_consume_token(RBRACE);
                                                                                                                                                                {if (true) return productionEndTerminal("indexer_declaration_interface","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = indexer_baseInt(true);
                                                                           replaceName(n);
                                                                                               ...
                                                                                               {if (true) return productionEndTerminal("indexer_base","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo indexer_baseInt(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      n = identifier(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("indexer_baseInt1","-","-","error",first,token);}
      break;
    case THIS:
      jj_consume_token(THIS);
                 {if (true) return productionEndTerminal("indexer_baseInt2","-","-","error",first,token);}
      break;
    default:
      jj_la1[155] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo operator_declaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_10(2147483647)) {
      ...
      n = unary_operator_declaration(true);
                                                                                                                                                    replaceName(n);
                                                                                                                                                                      {if (true) return productionEndTerminal("operator_declaration1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OPERATOR:
        jj_consume_token(OPERATOR);
        n = binary_operator_declaration(true);
                                                        replaceName(n);
                                                                          {if (true) return productionEndTerminal("operator_declaration2","-","-","error",first,token);}
        break;
      default:
        jj_la1[156] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo unary_operator_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                                                                                                        replaceName(n);
                                                                                                                                                                          {if (true) return productionEndTerminal("unary_operator_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo overloadable_unary_operator(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("overloadable_unary_operator1","-","-","error",first,token);}
      break;
    case MINUS:
      jj_consume_token(MINUS);
              {if (true) return productionEndTerminal("overloadable_unary_operator2","-","-","error",first,token);}
      break;
    case BANG:
      jj_consume_token(BANG);
              {if (true) return productionEndTerminal("overloadable_unary_operator3","-","-","error",first,token);}
      break;
    case TILDE:
      jj_consume_token(TILDE);
              {if (true) return productionEndTerminal("overloadable_unary_operator4","-","-","error",first,token);}
      break;
    case INC:
      jj_consume_token(INC);
               {if (true) return productionEndTerminal("overloadable_unary_operator5","-","-","error",first,token);}
      break;
    case DEC:
      jj_consume_token(DEC);
               {if (true) return productionEndTerminal("overloadable_unary_operator6","-","-","error",first,token);}
      break;
    case TRUE:
      jj_consume_token(TRUE);
                 {if (true) return productionEndTerminal("overloadable_unary_operator7","-","-","error",first,token);}
      break;
    case FALSE:
      jj_consume_token(FALSE);
                  {if (true) return productionEndTerminal("overloadable_unary_operator8","-","-","error",first,token);}
      break;
    default:
      jj_la1[157] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo binary_operator_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                                                                                                                                                                                 replaceName(n);
                                                                                                                                                                                                                                                   {if (true) return productionEndTerminal("binary_operator_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo overloadable_binary_operator(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("overloadable_binary_operator1","-","-","error",first,token);}
      break;
    case MINUS:
      jj_consume_token(MINUS);
              {if (true) return productionEndTerminal("overloadable_binary_operator2","-","-","error",first,token);}
      break;
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("overloadable_binary_operator3","-","-","error",first,token);}
      break;
    case DIV:
      jj_consume_token(DIV);
              {if (true) return productionEndTerminal("overloadable_binary_operator4","-","-","error",first,token);}
      break;
    case MOD:
      jj_consume_token(MOD);
              {if (true) return productionEndTerminal("overloadable_binary_operator5","-","-","error",first,token);}
      break;
    case AMPER:
      jj_consume_token(AMPER);
              {if (true) return productionEndTerminal("overloadable_binary_operator6","-","-","error",first,token);}
      break;
    case BOR:
      jj_consume_token(BOR);
              {if (true) return productionEndTerminal("overloadable_binary_operator7","-","-","error",first,token);}
      break;
    case CARET:
      jj_consume_token(CARET);
              {if (true) return productionEndTerminal("overloadable_binary_operator8","-","-","error",first,token);}
      break;
    case SL:
      jj_consume_token(SL);
               {if (true) return productionEndTerminal("overloadable_binary_operator9","-","-","error",first,token);}
      break;
    case SR:
      jj_consume_token(SR);
               {if (true) return productionEndTerminal("overloadable_binary_operator10","-","-","error",first,token);}
      break;
    case EQUAL:
      jj_consume_token(EQUAL);
               {if (true) return productionEndTerminal("overloadable_binary_operator11","-","-","error",first,token);}
      break;
    case NOT_EQUAL:
      jj_consume_token(NOT_EQUAL);
               {if (true) return productionEndTerminal("overloadable_binary_operator12","-","-","error",first,token);}
      break;
    case GTHAN:
      jj_consume_token(GTHAN);
              {if (true) return productionEndTerminal("overloadable_binary_operator13","-","-","error",first,token);}
      break;
    case LTHAN:
      jj_consume_token(LTHAN);
              {if (true) return productionEndTerminal("overloadable_binary_operator14","-","-","error",first,token);}
      break;
    case GE:
      jj_consume_token(GE);
               {if (true) return productionEndTerminal("overloadable_binary_operator15","-","-","error",first,token);}
      break;
    case LE:
      jj_consume_token(LE);
               {if (true) return productionEndTerminal("overloadable_binary_operator16","-","-","error",first,token);}
      break;
    default:
      jj_la1[158] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo conversion_operator_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                                                                                                                                          replaceName(n);
                                                                                                                                                                                                            {if (true) return productionEndTerminal("conversion_operator_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo conversion_operator(boolean inTerminal) throws ParseException {
    ...
    case IMPLICIT:
      jj_consume_token(IMPLICIT);
                     {if (true) return productionEndTerminal("conversion_operator1","-","-","error",first,token);}
      break;
    case EXPLICIT:
      jj_consume_token(EXPLICIT);
                     {if (true) return productionEndTerminal("conversion_operator2","-","-","error",first,token);}
      break;
    default:
      jj_la1[159] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo constructor_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                                                                                    replaceName(n);
                                                                                                                                                      {if (true) return productionEndTerminal("constructor_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo constructor_initializer(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
                                                                                                                    {if (true) return productionEndTerminal("constructor_initializer","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo constructor_initializerInt(boolean inTerminal) throws ParseException {
    ...
    case BASE:
      jj_consume_token(BASE);
                 {if (true) return productionEndTerminal("constructor_initializerInt1","-","-","error",first,token);}
      break;
    case THIS:
      jj_consume_token(THIS);
                 {if (true) return productionEndTerminal("constructor_initializerInt2","-","-","error",first,token);}
      break;
    default:
      jj_la1[163] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo destructor_declaration(boolean inTerminal) throws ParseException {
    ...
    n = body(true);
                                                                       replaceName(n);
                                                                                         {if (true) return productionEndTerminal("destructor_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo base_interfaces(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(COLON);
    n = interface_type_list(true);
                                         replaceName(n);
                                                           {if (true) return productionEndTerminal("base_interfaces","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo array_initializer(boolean inTerminal) throws ParseException {
    ...
    n = rest_of_array_initializer(true);
                                               replaceName(n);
                                                                 {if (true) return productionEndTerminal("array_initializer","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo rest_of_array_initializer(boolean inTerminal) throws ParseException {
    ...
    case RBRACE:
      jj_consume_token(RBRACE);
              {if (true) return productionEndTerminal("rest_of_array_initializer1","-","-","error",first,token);}
      break;
    case LONG:
    case BASE:
    case NEW:
    ...
    case VERBATIM_STRING_LITERAL:
      ...
      n = rest_of_array_initializerEnd(true);
                                                                                             replaceName(n);
                                                                                                               {if (true) return productionEndTerminal("rest_of_array_initializer2","-","-","error",first,token);}
      break;
    default:
      jj_la1[168] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo rest_of_array_initializerEnd(boolean inTerminal) throws ParseException {
    ...
    case RBRACE:
      jj_consume_token(RBRACE);
              {if (true) return productionEndTerminal("rest_of_array_initializerEnd1","-","-","error",first,token);}
      break;
    case COMMA:
      jj_consume_token(COMMA);
      n = rest_of_array_initializer(true);
                                               replaceName(n);
                                                                 {if (true) return productionEndTerminal("rest_of_array_initializerEnd2","-","-","error",first,token);}
      break;
    default:
      jj_la1[169] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo interface_body(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      n = interface_member_declaration(true);
                                                   replaceName(n);
    }
    jj_consume_token(RBRACE);
                                                                           {if (true) return productionEndTerminal("interface_body","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_member_declaration(boolean inTerminal) throws ParseException {
    ...
    n = interface_member_declarationEnd(true);
                                                                                                                                               replaceName(n);
                                                                                                                                                                 {if (true) return productionEndTerminal("interface_member_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_member_declarationEnd(boolean inTerminal) throws ParseException {
    ...
    case EVENT:
      n = interface_event_declaration(true);
                                             replaceName(n);
                                                               {if (true) return productionEndTerminal("interface_member_declarationEnd1","-","-","error",first,token);}
      break;
    case LONG:
    case BOOL:
    case OBJECT:
    ...
    case IDENTIFIER:
      ...
      n = interface_member_declarationEndType(true);
                                                                                    replaceName(n);
                                                                                                      {if (true) return productionEndTerminal("interface_member_declarationEnd2","-","-","error",first,token);}
      break;
    default:
      jj_la1[177] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo interface_member_declarationEndType(boolean inTerminal) throws ParseException {
    ...
    case THIS:
      n = interface_indexer_declaration(true);
                                               replaceName(n);
                                                                 {if (true) return productionEndTerminal("interface_member_declarationEndType1","-","-","error",first,token);}
      break;
    case ASSEMBLY:
    case MODULE:
    case IDENTIFIER:
      ...
      n = interface_member_declarationEndTypeIdentifier(true);
                                                                                                    replaceName(n);
                                                                                                                      {if (true) return productionEndTerminal("interface_member_declarationEndType2","-","-","error",first,token);}
      break;
    default:
      jj_la1[178] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo interface_member_declarationEndTypeIdentifier(boolean inTerminal) throws ParseException {
    ...
    case LTHAN:
      n = interface_method_declaration(true);
                                              replaceName(n);
                                                                {if (true) return productionEndTerminal("interface_member_declarationEndTypeIdentifier1","-","-","error",first,token);}
      break;
    case LBRACE:
      n = interface_property_declaration(true);
                                                replaceName(n);
                                                                  {if (true) return productionEndTerminal("interface_member_declarationEndTypeIdentifier2","-","-","error",first,token);}
      break;
    default:
      jj_la1[179] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo interface_member_modifier(boolean inTerminal) throws ParseException {
    ...
    case NEW:
      jj_consume_token(NEW);
                {if (true) return productionEndTerminal("interface_member_modifier1","-","-","error",first,token);}
      break;
    case UNSAFE:
      jj_consume_token(UNSAFE);
                   {if (true) return productionEndTerminal("interface_member_modifier2","-","-","error",first,token);}
      break;
    default:
      jj_la1[180] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo interface_event_declaration(boolean inTerminal) throws ParseException {
    ...
    n = identifier(true);
                                                                   replaceName(n);
    jj_consume_token(SEMI);
                                                                                         {if (true) return productionEndTerminal("interface_event_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_indexer_declaration(boolean inTerminal) throws ParseException {
    ...
    n = interface_accessors(true);
                                                                                                        replaceName(n);
    jj_consume_token(RBRACE);
                                                                                                                              {if (true) return productionEndTerminal("interface_indexer_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_method_declaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
    jj_consume_token(SEMI);
                                                                                                                                                                                     {if (true) return productionEndTerminal("interface_method_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_property_declaration(boolean inTerminal) throws ParseException {
    ...
    n = interface_accessors(true);
                                         replaceName(n);
    jj_consume_token(RBRACE);
                                                               {if (true) return productionEndTerminal("interface_property_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_accessors(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                     ...
                                                                                                     {if (true) return productionEndTerminal("interface_accessors","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo interface_accessor(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
    jj_consume_token(SEMI);
                                                                 {if (true) return productionEndTerminal("interface_accessor","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo enum_base(boolean inTerminal) throws ParseException {
    ...
    n = integral_type(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("enum_base","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo enum_body(boolean inTerminal) throws ParseException {
    ...
    n = rest_of_enum_body(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("enum_body","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo rest_of_enum_body(boolean inTerminal) throws ParseException {
    ...
    case RBRACE:
      jj_consume_token(RBRACE);
              {if (true) return productionEndTerminal("rest_of_enum_body1","-","-","error",first,token);}
      break;
    case ASSEMBLY:
    case MODULE:
    case LBRACK:
    case IDENTIFIER:
      ...
      n = rest_of_enum_bodyEnd(true);
                                                                                        replaceName(n);
                                                                                                          {if (true) return productionEndTerminal("rest_of_enum_body2","-","-","error",first,token);}
      break;
    default:
      jj_la1[188] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo rest_of_enum_bodyEnd(boolean inTerminal) throws ParseException {
    ...
    case RBRACE:
      jj_consume_token(RBRACE);
              {if (true) return productionEndTerminal("rest_of_enum_bodyEnd1","-","-","error",first,token);}
      break;
    case COMMA:
      jj_consume_token(COMMA);
      n = rest_of_enum_body(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("rest_of_enum_bodyEnd2","-","-","error",first,token);}
      break;
    default:
      jj_la1[189] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo enum_member_declaration(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                                        ...
                                                                                                                                        {if (true) return productionEndTerminal("enum_member_declaration","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo enum_member_assignment(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("enum_member_assignment","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      default:
        ...
        break label_33;
                                                              ...
                                                              {if (true) return productionEndTerminal("attributes_either","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo attribute_section_start(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_11(2147483647)) {
      ...
      n = attribute_section(true);
                                                                                                                                             replaceName(n);
                                                                                                                                                               {if (true) return productionEndTerminal("attribute_section_start1","-","-","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LBRACK:
        jj_consume_token(LBRACK);
        ...
        n = attribute_section(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("attribute_section_start2","-","-","error",first,token);}
        break;
      default:
        jj_la1[197] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo global_attribute_target_specifier(boolean inTerminal) throws ParseException {
    ...
    n = global_attribute_target(true);
                                         replaceName(n);
    jj_consume_token(COLON);
                                                               {if (true) return productionEndTerminal("global_attribute_target_specifier","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo global_attribute_target(boolean inTerminal) throws ParseException {
    ...
    case ASSEMBLY:
      jj_consume_token(ASSEMBLY);
                     {if (true) return productionEndTerminal("global_attribute_target1","-","-","error",first,token);}
      break;
    case MODULE:
      jj_consume_token(MODULE);
                   {if (true) return productionEndTerminal("global_attribute_target2","-","-","error",first,token);}
      break;
    default:
      jj_la1[198] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      default:
        ...
        break label_34;
                                                      ...
                                                      {if (true) return productionEndTerminal("attributes","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_attribute(boolean inTerminal) throws ParseException {
    ...
    n = attribute_section(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("local_attribute","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo attribute_section(boolean inTerminal) throws ParseException {
    ...
    n = attribute_sectionEnd(true);
                                                                          replaceName(n);
                                                                                            {if (true) return productionEndTerminal("attribute_section","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo attribute_sectionEnd(boolean inTerminal) throws ParseException {
    ...
    case RBRACK:
      jj_consume_token(RBRACK);
              {if (true) return productionEndTerminal("attribute_sectionEnd1","-","-","error",first,token);}
      break;
    default:
      jj_la1[201] = jj_gen;
      if (jj_2_12(2)) {
        jj_consume_token(COMMA);
        jj_consume_token(RBRACK);
                               {if (true) return productionEndTerminal("attribute_sectionEnd2","-","-","error",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
          jj_consume_token(COMMA);
          n = attribute_section(true);
                                       replaceName(n);
                                                         {if (true) return productionEndTerminal("attribute_sectionEnd3","-","-","error",first,token);}
          break;
        default:
          jj_la1[202] = jj_gen;
          jj_consume_token(-1);
  ...
  final public FSTInfo attribute_target_specifier(boolean inTerminal) throws ParseException {
    ...
    n = attribute_target(true);
                                  replaceName(n);
    jj_consume_token(COLON);
                                                        {if (true) return productionEndTerminal("attribute_target_specifier","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo attribute_target(boolean inTerminal) throws ParseException {
    ...
    case EVENT:
      jj_consume_token(EVENT);
                  {if (true) return productionEndTerminal("attribute_target1","-","-","error",first,token);}
      break;
    case RETURN:
      jj_consume_token(RETURN);
                   {if (true) return productionEndTerminal("attribute_target2","-","-","error",first,token);}
      break;
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("attribute_target3","-","-","error",first,token);}
      break;
    default:
      jj_la1[203] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo attribute(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                             ...
                                                                                             {if (true) return productionEndTerminal("attribute","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo attribute_arguments(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
                                                             {if (true) return productionEndTerminal("attribute_arguments","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo sizeof_expression(boolean inTerminal) throws ParseException {
    ...
    n = type(true);
                                   replaceName(n);
    jj_consume_token(RPAREN);
                                                         {if (true) return productionEndTerminal("sizeof_expression","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo unsafe_statement(boolean inTerminal) throws ParseException {
    ...
    n = block(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("unsafe_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo pointer_member_access(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
                           {if (true) return productionEndTerminal("pointer_member_access","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo fixed_statement(boolean inTerminal) throws ParseException {
    ...
    n = embedded_statement(true);
                                                                                                                                       replaceName(n);
                                                                                                                                                         {if (true) return productionEndTerminal("fixed_statement","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = fixed_pointer_declarator(true);
                                                                                                  replaceName(n);
                                                                                                                      ...
                                                                                                                      {if (true) return productionEndTerminal("fixed_pointer_declarators","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo fixed_pointer_declarator(boolean inTerminal) throws ParseException {
    ...
    n = fixed_pointer_initializer(true);
                                                                                    replaceName(n);
                                                                                                      {if (true) return productionEndTerminal("fixed_pointer_declarator","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo fixed_pointer_initializer(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("fixed_pointer_initializer","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo stackalloc_initializer(boolean inTerminal) throws ParseException {
    ...
    n = expression(true);
                                                                                      replaceName(n);
    jj_consume_token(RBRACK);
                                                                                                            {if (true) return productionEndTerminal("stackalloc_initializer","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
